...
The model compares explicitly supplied structured options. It finds the smallest calculated change that crosses a configurable approval threshold. It makes no claim that the result is a collective decision. Version 1.5.54 keeps the 1.5.0 review packet contract. Workshop display filters, print redaction, pasted tables, lock copy, unique group copies, and `moveClause` do not change search math. A veto is a number, not a legal right. Locks are draft choices, not a legal hold. Bottle-hand cycling club hours is a bidon-pass / car-window / crate-lock workshop with first-without-floor remaining 31, last-without-floor remaining 33, and groups-without-floor remaining 83, distinct from domestique cycling club hours (wheel-change / neutral-service / team-car, remaining 30 / 32 / 81), soigneur cycling club hours (soigneur-station / cape-bag / rice-cake, remaining 29 / 31 / 79), lead-out cycling club hours (train-line / last-rider / sprinter-launch, remaining 28 / 30 / 77), feed-zone cycling club hours (musette-line / sticky-bottle / bottle-hand-up, remaining 27 / 29 / 75), first-aid cycling club hours (treatment-tent / ice-pack-rota / triage-board, remaining 26 / 28 / 73), team-sprint cycling club hours (start-gate / flying-relay / trio-board), team-pursuit cycling club hours (team-pursuit-rota / changeover-bell / quartet-board), individual-pursuit cycling club hours (pursuit-line / catch-bell / pursuit-chip), scratch cycling club hours (scratch-bunch / bunch-finish / scratch-chip), points-race cycling club hours (points-sprint / bell-lap / prime-board), omnium cycling club hours (flying-200 / tempo-board), madison cycling club hours (madison-pair / handsling / pairing-board), keirin cycling club hours (derny-pacer / keirin-chip), hill-climb cycling club hours (summit-marshal / climb-chip), time-trial cycling club hours (start-ramp / time-check / timing-chip), criterium cycling club hours (closed-circuit / pit-lane / number-board) and road cycling club hours (sealed-road / feed-station / wheel-bag). First-aid remains a treatment-tent / ice-pack-rota / triage-board workshop.
