...
test("standalone artifact is current, self-contained, and LF-normalized", async () => {
  ...
  assert.match(html, /a one-line lock count, and the first locked clause option label as one line on the worksheet/u);
