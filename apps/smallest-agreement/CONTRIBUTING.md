...
- Display filters such as hideVetoGroups, hideNonVetoGroups, hideGroupsBelowThreshold, hideGroupsMeetingThreshold, and hideGroupsAtFloor must not change search math. Persist them as optional workspace booleans, reject unknown keys, and default omitted flags to show-all.
