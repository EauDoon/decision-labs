...
`redactConfiguration` copies a valid case, deletes `deal.title` and `deal.notes` if present, and replaces each participant `name` with `Participant 1` through `N`. Identifiers, shares, costs, stress settings, and currency are unchanged. This is a sharing aid, not encryption. Print redacted uses the same Participant 1 through N labels on the print path and in the print stylesheet without changing the saved case. Print one-pager includes the least-headroom participant line, an allocation-balance line, a deal title line, a currency code line, the first-breakpoint participant label line, the first-breakpoint remaining-to-hold line, the first-breakpoint volume-to-hold line, the over-capacity participant count line, the first over-capacity participant label line, the first over-capacity remaining listed capacity line, the last over-capacity participant label line, the last over-capacity remaining listed capacity line, and the first within-capacity remaining listed capacity line, and the last within-capacity remaining listed capacity line when the case is valid. The remaining-to-hold line is honest when that amount is unavailable. The first over-capacity participant label line is an honest empty when none are over. The first over-capacity remaining listed capacity line is an honest empty when none are over. The last over-capacity participant label line is an honest empty when none are over. The last over-capacity remaining listed capacity line is an honest empty when none are over. The first within-capacity remaining listed capacity line is an honest empty when none are within listed capacity. The last within-capacity remaining listed capacity line is an honest empty when none are within listed capacity. Remaining listed capacity is not a forecast. The last spare-capacity remaining listed capacity line, the first spare-capacity remaining listed capacity line, the last unbounded remaining-to-hold line, and the first unbounded remaining-to-hold line are included when the case is valid. The last unbounded remaining-to-hold line is an honest empty when none have unbounded or omitted capacity. The first unbounded remaining-to-hold line is an honest empty when none have unbounded or omitted capacity. The first zero-share volume-to-hold line is included when the case is valid. The line is an honest empty when none have zero revenue share. Volume that is not a finite amount is named as such. The saved case is unchanged.

Copy first-breakpoint remaining-to-hold copies the volume or share still needed for the first-breakpoint participant as one Markdown line, or an honest empty line when that amount is unavailable. Copy first-breakpoint volume-to-hold copies that participant's exit volume from the same result, or an honest empty line when exit volume is unavailable. Copy first over-capacity remaining listed capacity copies how far over listed capacity the first over-capacity roster row currently is, or an honest empty line when none are over. Copy last over-capacity participant label copies the name of the last roster row currently over listed capacity as one Markdown line, or an honest empty line when none are over. Copy last over-capacity remaining listed capacity copies how far over listed capacity the last over-capacity roster row currently is, or an honest empty line when none are over. Copy first within-capacity remaining listed capacity copies remaining listed capacity for the first roster row that is within listed capacity as one Markdown line, or an honest empty line when none. Copy last within-capacity remaining listed capacity copies remaining listed capacity for the last roster row that is within listed capacity as one Markdown line, or an honest empty line when none. Copy last first-breakpoint participant label copies the name of the last roster row that is the first-breakpoint as one Markdown line, or an honest empty line when none. Copy last unbounded remaining-to-hold copies remaining to hold for the last roster row whose capacity is unbounded or omitted as one Markdown line, or an honest empty line when none. Copy first unbounded remaining-to-hold copies remaining to hold for the first roster row whose capacity is unbounded or omitted as one Markdown line, or an honest empty line when none. Copy first zero-share volume-to-hold copies volume to hold for the first roster row with zero revenue share as one Markdown line, or an honest empty line when none. When volume to hold is not a finite amount, the line says so rather than inventing a volume. It is distinct from last zero-share volume-to-hold copy, last zero-share remaining-to-hold copy, first zero-share remaining-to-hold copy, first zero-share participant label copy, last zero-share participant label copy, and first-breakpoint volume-to-hold copy. It is organizer or planner copy, not a forecast of who will exit. Those copy controls are distinct from each other and from least-headroom, first-breakpoint label, over-capacity count, first over-capacity label, first spare-capacity remaining, and last spare-capacity remaining copy. Remaining listed capacity is not a forecast. Counts remain counts. Ranking is not a forecast of who will exit.
...
Optional `hideZeroShareParticipants` on a saved case is a boolean roster display preference. Older files omit it and default to showing zero-share rows. Present non-boolean values are rejected. Hiding zero-share participants filters the roster cards only. Tested-case and model counts stay unchanged. The solver is unchanged. Hide participants with zero revenue share stays on screen as a button without `Shift+F12`. Keyboard `Shift+F12` jumps to Hide the last participant with zero revenue share, or the Participants heading if missing. `Shift+F12` does not toggle. It is distinct from `F12` last-zero-share hide jump, which keeps the same target, `F9` first-zero-share hide jump, and `ArrowRight` first-zero-share hide. `hideHoldingParticipants` and `hideAllHoldLedger` remain independent flags.
...
Optional `hideParticipantsWithinCapacity` on a saved case is a boolean roster display preference. Older files omit it and default to showing roster rows that are within listed capacity (not over capacity). Present non-boolean values are rejected. Hiding those rows filters the roster cards only. Tested-case and model counts stay unchanged. The solver is unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, and `hideParticipantsAtLeastHeadroom` remain independent flags.

Optional `hideFirstBreakpointParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first-breakpoint roster row. Present non-boolean values are rejected. Hiding that row filters the roster cards only. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, and `hideParticipantsWithinCapacity` remain independent flags.

Optional `hideFirstOverCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first over-capacity roster row. Present non-boolean values are rejected. Hiding that row filters only the first roster card currently over listed capacity. It is distinct from `hideParticipantsOverCapacity`, which hides every over-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, and `hideFirstBreakpointParticipant` remain independent flags.

Optional `hideLastOverCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last over-capacity roster row. Present non-boolean values are rejected. Hiding that row filters only the last roster card currently over listed capacity. It is distinct from `hideFirstOverCapacityParticipant`, which hides the first over-capacity row, and from `hideParticipantsOverCapacity`, which hides every over-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, and `hideFirstOverCapacityParticipant` remain independent flags.

Optional `hideLastBreakpointParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last first-breakpoint roster row. Present non-boolean values are rejected. Hiding that row filters only the last roster card that is the first-breakpoint. If the model exposes a single first-breakpoint participant, hiding last first-breakpoint hides that one row. It is distinct from `hideFirstBreakpointParticipant`, which hides the first-breakpoint row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, and `hideLastOverCapacityParticipant` remain independent flags.

Optional `hideLastWithinCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last within-capacity roster row. Present non-boolean values are rejected. Hiding that row filters only the last roster card currently within listed capacity. It is distinct from `hideParticipantsWithinCapacity`, which hides every within-capacity row, and from `hideLastOverCapacityParticipant`, which hides the last over-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, and `hideLastBreakpointParticipant` remain independent flags.

Optional `hideFirstWithinCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first within-capacity roster row. Present non-boolean values are rejected. Hiding that row filters only the first roster card currently within listed capacity. It is distinct from `hideLastWithinCapacityParticipant`, which hides the last within-capacity row, and from `hideParticipantsWithinCapacity`, which hides every within-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, and `hideLastWithinCapacityParticipant` remain independent flags.

Optional `hideLastSpareCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last roster row that currently has unused listed capacity (`capacity - volume > 1e-9`), using roster order. Present non-boolean values are rejected. Hiding that row filters only that last spare-capacity roster card. Hidden rows still count. It is distinct from `hideParticipantsWithSpareCapacity`, which hides every unused-capacity row, from `hideLastWithinCapacityParticipant`, which hides the last within-capacity row, and from `hideFirstSpareCapacityParticipant`, which hides the first spare-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, and `hideFirstSpareCapacityParticipant` remain independent flags.

Optional `hideFirstSpareCapacityParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first roster row that currently has unused listed capacity (`capacity - volume > 1e-9`), using roster order. Present non-boolean values are rejected. Hiding that row filters only that first spare-capacity roster card. Hidden rows still count. It is distinct from `hideLastSpareCapacityParticipant`, which hides the last spare-capacity row, and from `hideParticipantsWithSpareCapacity`, which hides every unused-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, and `hideLastSpareCapacityParticipant` remain independent flags.

Optional `hideLastParticipantWithoutCapacity` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last roster row whose capacity is unbounded or omitted, using roster order. Present non-boolean values are rejected. Hiding that row filters only that last unbounded or omitted-capacity roster card. Hidden rows still count. If the roster has a single unbounded or omitted-capacity participant, hiding last hides that one row. It is distinct from `hideParticipantsWithoutCapacity`, which hides every unbounded or omitted-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, and `hideFirstSpareCapacityParticipant` remain independent flags.

Optional `hideFirstParticipantWithoutCapacity` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first roster row whose capacity is unbounded or omitted, using roster order. Present non-boolean values are rejected. Hiding that row filters only that first unbounded or omitted-capacity roster card. Hidden rows still count. If the roster has a single unbounded or omitted-capacity participant, hiding first hides that one row. It is distinct from `hideLastParticipantWithoutCapacity`, which hides the last unbounded or omitted-capacity row, and from `hideParticipantsWithoutCapacity`, which hides every unbounded or omitted-capacity row. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, `hideFirstSpareCapacityParticipant`, and `hideLastParticipantWithoutCapacity` remain independent flags.

Optional `hideLastParticipantAtHold` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last roster row currently at hold (remaining-to-hold is 0), using roster order. Present non-boolean values are rejected. Hiding that row filters only that last at-hold roster card. Hidden rows still count. If only one roster row is currently at hold, hiding last hides that one row. It is distinct from `hideParticipantsAtHold`, which hides every at-hold row with no listed capacity breach, from `hideLastBreakpointParticipant`, from `hideFirstParticipantWithoutCapacity`, and from `hideLastParticipantWithoutCapacity`. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, `hideFirstSpareCapacityParticipant`, `hideLastParticipantWithoutCapacity`, `hideFirstParticipantWithoutCapacity`, and `hideFirstParticipantAtHold` remain independent flags.

Optional `hideFirstParticipantAtHold` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first roster row currently at hold (remaining-to-hold is 0), using roster order. Present non-boolean values are rejected. Hiding that row filters only that first at-hold roster card. Hidden rows still count. If only one roster row is currently at hold, hiding first hides that one row. It is distinct from `hideParticipantsAtHold`, which hides every at-hold row with no listed capacity breach, from `hideLastParticipantAtHold`, from `hideFirstParticipantWithoutCapacity`, and from `hideLastParticipantWithoutCapacity`. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, `hideFirstSpareCapacityParticipant`, `hideLastParticipantWithoutCapacity`, `hideFirstParticipantWithoutCapacity`, `hideLastParticipantAtHold`, and `hideFirstZeroShareParticipant` remain independent flags.

Optional `hideFirstZeroShareParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the first roster row with zero revenue share, using roster order. Present non-boolean values are rejected. Hiding that row filters only that first zero-share roster card. Hidden rows still count. If only one roster row currently has zero revenue share, hiding first hides that one row. It is distinct from `hideZeroShareParticipants`, which hides every zero-share row, from `hideLastZeroShareParticipant`, which hides the last zero-share row, from `hideFirstParticipantAtHold`, and from `hideLastParticipantAtHold`. Copy first zero-share participant label names that first roster row as one-line Markdown, or an honest empty line when none. Copy first zero-share remaining-to-hold names remaining to hold for that first roster row as one-line Markdown, or an honest empty line when none. When remaining is not a finite amount, the line says so rather than inventing a volume. The prefix is distinct from first zero-share participant copy, last zero-share participant copy, last zero-share remaining-to-hold, first at-hold remaining-to-hold, last at-hold remaining-to-hold, last unbounded remaining-to-hold, and first unbounded remaining-to-hold. It is organizer or planner copy, not a forecast of who will exit. Copy first zero-share volume-to-hold names volume to hold for that first roster row as one-line Markdown, or an honest empty line when none. When volume to hold is not a finite amount, the line says so rather than inventing a volume. The volume prefix is distinct from last zero-share volume-to-hold, last zero-share remaining-to-hold, first zero-share remaining-to-hold, first zero-share participant copy, last zero-share participant copy, and first-breakpoint volume-to-hold. It is organizer or planner copy, not a forecast of who will exit. Keyboard `F7` copies the first-zero-share label. Keyboard `F8` jumps to Copy first zero-share participant label, or the Participants heading if missing. Keyboard `F9` jumps to Hide the first participant with zero revenue share, or the Participants heading if missing. `ArrowRight` keeps that same hide jump. `F9` does not copy. Unshifted `F10`, `F11`, and `F12` stay last-zero-share remaining copy, jump, and hide. `Shift+F10` copies first zero-share volume-to-hold. `Shift+F11` jumps to Copy first zero-share volume-to-hold. `Shift+F12` jumps to Hide the last participant with zero revenue share. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, `hideFirstSpareCapacityParticipant`, `hideLastParticipantWithoutCapacity`, `hideFirstParticipantWithoutCapacity`, `hideLastParticipantAtHold`, `hideFirstParticipantAtHold`, and `hideLastZeroShareParticipant` remain independent flags.

Optional `hideLastZeroShareParticipant` on a saved case is a boolean roster display preference. Older files omit it and default to showing the last roster row with zero revenue share, using roster order. Present non-boolean values are rejected. Hiding that row filters only that last zero-share roster card. Hidden rows still count. If only one roster row currently has zero revenue share, hiding last hides that one row. It is distinct from `hideZeroShareParticipants`, which hides every zero-share row, from `hideFirstZeroShareParticipant`, which hides the first zero-share row, and from ArrowRight first-zero-share hide. Copy last zero-share remaining-to-hold names remaining to hold for that last roster row as one-line Markdown, or an honest empty line when none. When remaining is not a finite amount, the line says so rather than inventing a volume. Copy last zero-share volume-to-hold names volume to hold for that last roster row as one-line Markdown, or an honest empty line when none. When volume to hold is not a finite amount, the line says so rather than inventing a volume. The volume prefix is distinct from last zero-share remaining-to-hold, first zero-share remaining-to-hold, first zero-share volume-to-hold, first zero-share participant copy, last zero-share participant copy, and first-breakpoint volume-to-hold. It is organizer or planner copy, not a forecast of who will exit. Keyboard `F10` copies remaining-to-hold. Last zero-share volume-to-hold copy stays available without `Shift+F10`. Keyboard `Shift+F10` copies first zero-share volume-to-hold. Keyboard `F11` jumps to Copy last zero-share remaining-to-hold, or the Participants heading if missing. Keyboard `Shift+F11` jumps to Copy first zero-share volume-to-hold, or the Participants heading if missing. Keyboard `F12` jumps to Hide the last participant with zero revenue share, or the Participants heading if missing. Keyboard `Shift+F12` jumps to Hide the last participant with zero revenue share, or the Participants heading if missing. `F12` does not copy. `F12` is distinct from `F9` first-zero-share hide jump. `Shift+F12` is distinct from hide-all zero-share (`hideZeroShareParticipants`), which stays available without that shortcut. `ArrowRight` keeps first-zero-share hide. `F7`, `F8`, and `F9` stay first-zero-share tools. Tested-case and model counts stay unchanged. The solver is unchanged. Matching and ranking are unchanged. `hideHoldingParticipants`, `hideAllHoldLedger`, `hideZeroShareParticipants`, `hideParticipantsOverCapacity`, `hideParticipantsAtHold`, `hideParticipantsWithoutCapacity`, `hideParticipantsWithSpareCapacity`, `hideParticipantsAtLeastHeadroom`, `hideParticipantsWithinCapacity`, `hideFirstBreakpointParticipant`, `hideFirstOverCapacityParticipant`, `hideLastOverCapacityParticipant`, `hideLastBreakpointParticipant`, `hideLastWithinCapacityParticipant`, `hideFirstWithinCapacityParticipant`, `hideLastSpareCapacityParticipant`, `hideFirstSpareCapacityParticipant`, `hideLastParticipantWithoutCapacity`, `hideFirstParticipantWithoutCapacity`, `hideLastParticipantAtHold`, `hideFirstParticipantAtHold`, and `hideFirstZeroShareParticipant` remain independent flags.

Hockey carnival split is a synthetic three-party carnival committee, ice hire, and first-aid starting point. Baseball carnival split is a distinct synthetic three-party carnival committee, diamond hire, and first-aid starting point. Softball carnival split is a distinct synthetic three-party carnival committee, diamond hire, and first-aid starting point with monthly volume 4000, fee 8, addressable volume 5200, and listed capacities 4900, 6000, and 4000. Lacrosse carnival split is a distinct synthetic three-party carnival committee, ground hire, and first-aid starting point with monthly volume 4100, fee 8, addressable volume 5300, and listed capacities 5000, 6100, and 4100. Water polo carnival split is a distinct synthetic three-party carnival committee, pool hire, and first-aid starting point with monthly volume 4200, fee 8, addressable volume 5400, and listed capacities 5100, 6200, and 4200. Rowing carnival split is a distinct synthetic three-party carnival committee, boat hire, and first-aid starting point with monthly volume 4300, fee 8, addressable volume 5500, and listed capacities 5200, 6300, and 4300. Sailing carnival split is a distinct synthetic three-party carnival committee, yacht club hire, and first-aid starting point with monthly volume 4400, fee 8, addressable volume 5600, and listed capacities 5300, 6400, and 4400. Canoeing carnival split is a distinct synthetic three-party carnival committee, paddle club hire, and first-aid starting point with monthly volume 4500, fee 8, addressable volume 5700, and listed capacities 5400, 6500, and 4500. Canoeing is a canoe or paddle club split, not a boats or yacht split. Kayaking carnival split is a distinct synthetic three-party carnival committee, whitewater slalom hire, and first-aid starting point with monthly volume 4600, fee 8, addressable volume 5800, and listed capacities 5500, 6600, and 4600. Kayaking is a kayak, whitewater, or slalom split, not a canoe or paddle club split and not a boats or yacht split. Dragon boat carnival split is a distinct synthetic three-party carnival committee, dragon boat club hire, and first-aid starting point with monthly volume 4700, fee 8, addressable volume 5900, and listed capacities 5600, 6700, and 4700. Dragon boat is a dragon boat club split, not a kayak, whitewater, or slalom split and not a canoe or paddle club split. It is not live capacity. Surf carnival split is a distinct synthetic three-party carnival committee, surf club hire, and first-aid starting point with monthly volume 4800, fee 8, addressable volume 6000, and listed capacities 5700, 6800, and 4800. Surf is a surf club split, not a dragon boat club split, not a kayak, whitewater, or slalom split, not a canoe or paddle club split, not a boats or yacht split, and not a pool split. It is not live capacity. Volleyball carnival split is a synthetic three-party carnival committee, court hire, and first-aid starting point. Rugby carnival split is a distinct synthetic three-party carnival committee, ground hire, and first-aid starting point. Counts remain counts. Ranking is not a forecast of who will exit.
