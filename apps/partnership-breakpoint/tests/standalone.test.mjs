...
test('standalone retains 1.5.16 review tools and 1.5.17 copy controls', async () => {
  ...
  assert.match(html, /id="copy-last-zero-share-volume"[^>]*aria-keyshortcuts="Shift\+F10"/);
  ...
  assert.match(html, /id="hide-zero-share-participants"[^>]*aria-keyshortcuts="Shift\+F12"/);
  ...
  assert.match(shiftF10Slice, /copyLastZeroShareVolume/);
  ...
  assert.match(shiftF12Slice, /hide-zero-share-participants/);
