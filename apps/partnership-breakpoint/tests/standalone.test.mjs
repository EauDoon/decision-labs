...
test('standalone retains 1.5.16 review tools and 1.5.17 copy controls', async () => {
  ...
  assert.match(html, /id="copy-first-over-capacity-volume"[^>]*aria-keyshortcuts="Shift\+F10"/);
  ...
  assert.match(shiftF10Slice, /copyFirstOverCapacityVolume/);
  ...
  assert.match(shiftF11Slice, /copy-first-over-capacity-volume/);
  ...
  assert.match(shiftF12Slice, /hide-last-over-capacity-participant/);
  assert.doesNotMatch(shiftF12Slice, /hide-first-over-capacity-participant/);
