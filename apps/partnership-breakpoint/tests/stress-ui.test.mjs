...
test('standard navigation and function keys keep their browser behavior outside fields', async () => {
  ...
  for (const key of keys) {
    assert.equal(app.keydown(key), false, `${key} should not be prevented on the document`);
    assert.equal(app.keydown(key, { shiftKey: true }), false, `Shift+${key} should not be prevented on the document`);
  }
});
...
test('keyboard last-over-capacity remaining copy shortcuts stay on road cycling carnival', async () => {
  ...
  assert.match(road.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(road.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on criterium cycling carnival', async () => {
  ...
  assert.match(criterium.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(criterium.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on time-trial cycling carnival', async () => {
  ...
  assert.match(timeTrial.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(timeTrial.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on hill-climb cycling carnival', async () => {
  ...
  assert.match(hillClimb.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(hillClimb.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on keirin cycling carnival', async () => {
  ...
  assert.match(keirin.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(keirin.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on madison cycling carnival', async () => {
  ...
  assert.match(madison.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(madison.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on omnium cycling carnival', async () => {
  ...
  assert.match(omnium.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(omnium.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on points-race cycling carnival', async () => {
  ...
  assert.match(pointsRace.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(pointsRace.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on scratch cycling carnival', async () => {
  ...
  assert.match(scratch.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(scratch.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on individual-pursuit cycling carnival', async () => {
  ...
  assert.match(pursuit.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(pursuit.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on team-pursuit cycling carnival', async () => {
  ...
  assert.match(teamPursuit.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(teamPursuit.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on team-sprint cycling carnival', async () => {
  ...
  assert.match(teamSprint.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(teamSprint.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on first-aid cycling carnival', async () => {
  ...
  assert.match(firstAid.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(firstAid.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on feed-zone cycling carnival', async () => {
  ...
  assert.match(feedZone.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(feedZone.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on lead-out cycling carnival', async () => {
  ...
  assert.match(leadOut.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(leadOut.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on soigneur cycling carnival', async () => {
  ...
  assert.match(soigneur.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(soigneur.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on domestique cycling carnival', async () => {
  ...
  assert.match(domestique.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(domestique.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
...
test('keyboard last-over-capacity remaining copy shortcuts stay on bottle-hand cycling carnival', async () => {
  ...
  assert.match(bottleHand.markup(), /id="copy-last-over-capacity-remaining"[^>]*aria-keyshortcuts="\*"/);
  assert.match(bottleHand.markup(), /id="hide-last-over-capacity-participant"[^>]*aria-keyshortcuts="#"/);
