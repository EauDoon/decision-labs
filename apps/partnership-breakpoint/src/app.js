...
function handleShortcut(event) {
  ...
  if (event.key === 'F7' && event.shiftKey) copyLastOverCapacityRemaining();
  if (event.key === 'F7' && !event.shiftKey) copyFirstZeroShareParticipant();
  if (event.key === 'F10' && event.shiftKey) copyLastOverCapacityRemaining();
  ...
  return `<div class="help-overlay" role="dialog" aria-modal="true" aria-labelledby="help-title" data-focus-trap="dialog">
    <div class="coach-card" tabindex="-1">
      ...
      <ul class="shortcut-list">
        ...
        <li><kbd>Shift+F7</kbd> Copy last over-capacity remaining listed capacity as Markdown</li>
        <li><kbd>Shift+F8</kbd> Jump to Copy last over-capacity remaining listed capacity, or the Participants heading if missing</li>
