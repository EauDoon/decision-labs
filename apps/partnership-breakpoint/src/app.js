...
let lastZeroShareVolumeCopyText = '';
let firstZeroShareRemainingCopyText = '';
let firstZeroShareVolumeCopyText = '';
...
function checkpoint() {
  ...
  lastZeroShareVolumeCopyText = '';
  firstZeroShareRemainingCopyText = '';
  firstZeroShareVolumeCopyText = '';
    ...
    <aside class="panel inputs" aria-label="Deal inputs">
      ...
      <div class="panel-body">
        ...
        <section class="input-section" aria-labelledby="participant-inputs-title">
          ...
          <div class="button-row"><button type="button" id="hide-zero-share-participants" data-action="hide-zero-share-participants" aria-pressed="${hideZeroShareParticipants}">Hide participants with zero revenue share</button><button type="button" data-action="show-zero-share-participants" ${hideZeroShareParticipants ? '' : 'disabled'}>Show zero-share participants</button></div>
          <p class="notice">${zeroShareFilterNote}</p>
          <div class="button-row"><button type="button" id="hide-first-zero-share-participant" data-action="hide-first-zero-share-participant" aria-pressed="${hideFirstZeroShareParticipant}">Hide the first participant with zero revenue share</button><button type="button" data-action="show-first-zero-share-participant" ${hideFirstZeroShareParticipant ? '' : 'disabled'}>Show the first participant with zero revenue share</button><button type="button" id="copy-first-zero-share-participant" data-action="copy-first-zero-share-participant">Copy first zero-share participant label</button><button type="button" id="copy-first-zero-share-remaining" data-action="copy-first-zero-share-remaining">Copy first zero-share remaining-to-hold</button><button type="button" id="copy-first-zero-share-volume" data-action="copy-first-zero-share-volume">Copy first zero-share volume-to-hold</button></div>
          <p class="notice">${firstZeroShareFilterNote}</p>
          <div class="button-row"><button type="button" id="hide-last-zero-share-participant" data-action="hide-last-zero-share-participant" aria-pressed="${hideLastZeroShareParticipant}">Hide the last participant with zero revenue share</button><button type="button" data-action="show-last-zero-share-participant" ${hideLastZeroShareParticipant ? '' : 'disabled'}>Show the last participant with zero revenue share</button><button type="button" id="copy-last-zero-share-participant" data-action="copy-last-zero-share-participant">Copy last zero-share participant label</button><button type="button" id="copy-last-zero-share-remaining" data-action="copy-last-zero-share-remaining">Copy last zero-share remaining-to-hold</button><button type="button" id="copy-last-zero-share-volume" data-action="copy-last-zero-share-volume">Copy last zero-share volume-to-hold</button></div>
          <p class="notice">${lastZeroShareFilterNote}</p>
          <div class="button-row"><button type="button" data-action="hide-over-capacity-participants" aria-pressed="${hideParticipantsOverCapacity}" ${result ? '' : 'disabled title="Resolve invalid inputs before filtering the roster"'}>Hide participants whose volume is above listed capacity</button><button type="button" data-action="show-over-capacity-participants" ${hideParticipantsOverCapacity ? '' : 'disabled'}>Show over-capacity participants</button><button type="button" id="copy-over-capacity-count" data-action="copy-over-capacity-count" aria-keyshortcuts='"'>Copy over-capacity participant count</button><button type="button" id="copy-first-over-capacity-label" data-action="copy-first-over-capacity-label" aria-keyshortcuts="}">Copy first over-capacity participant label</button><button type="button" id="copy-first-over-capacity-remaining" data-action="copy-first-over-capacity-remaining" aria-keyshortcuts="~">Copy first over-capacity remaining listed capacity</button><button type="button" id="copy-first-over-capacity-volume" data-action="copy-first-over-capacity-volume">Copy first over-capacity volume-to-hold</button><button type="button" id="copy-last-over-capacity-label" data-action="copy-last-over-capacity-label" aria-keyshortcuts="(">Copy last over-capacity participant label</button><button type="button" id="copy-last-over-capacity-remaining" data-action="copy-last-over-capacity-remaining" aria-keyshortcuts="*">Copy last over-capacity remaining listed capacity</button><button type="button" id="copy-last-over-capacity-volume" data-action="copy-last-over-capacity-volume">Copy last over-capacity volume-to-hold</button></div>
          ...
          <div class="button-row"><button type="button" id="hide-last-at-hold-participant" data-action="hide-last-at-hold-participant" aria-pressed="${hideLastParticipantAtHold}" ${result ? '' : 'disabled title="Resolve invalid inputs before filtering the roster"'}>Hide the last participant at hold</button><button type="button" data-action="show-last-at-hold-participant" ${hideLastParticipantAtHold ? '' : 'disabled'}>Show the last participant at hold</button><button type="button" id="copy-last-at-hold-remaining" data-action="copy-last-at-hold-remaining">Copy last at-hold remaining-to-hold</button></div>
          <p class="notice">${lastAtHoldFilterNote}</p>
          <div class="button-row"><button type="button" id="hide-first-at-hold-participant" data-action="hide-first-at-hold-participant" aria-pressed="${hideFirstParticipantAtHold}" ${result ? '' : 'disabled title="Resolve invalid inputs before filtering the roster"'}>Hide the first participant at hold</button><button type="button" data-action="show-first-at-hold-participant" ${hideFirstParticipantAtHold ? '' : 'disabled'}>Show the first participant at hold</button><button type="button" id="copy-first-at-hold-remaining" data-action="copy-first-at-hold-remaining">Copy first at-hold remaining-to-hold</button></div>
          ...
          <div class="button-row"><button type="button" id="hide-first-without-capacity-participant" data-action="hide-first-without-capacity-participant" aria-pressed="${hideFirstParticipantWithoutCapacity}" ${result ? '' : 'disabled title="Resolve invalid inputs before filtering the roster"'}>Hide the first participant without listed capacity</button><button type="button" data-action="show-first-without-capacity-participant" ${hideFirstParticipantWithoutCapacity ? '' : 'disabled'}>Show the first participant without listed capacity</button><button type="button" id="copy-first-unbounded-remaining" data-action="copy-first-unbounded-remaining">Copy first unbounded remaining-to-hold</button></div>
...
function resultsPanel(result) {
  ...
  return `<section class="results" id="results-start">
    ...
    <section class="print-only print-keep"><h2>First over-capacity volume-to-hold</h2><p>${escapeAttribute(firstOverCapacityVolumeMarkdown(result))}</p></section>
    ...
    <section class="print-only print-keep"><h2>Last zero-share volume-to-hold</h2><p>${escapeAttribute(lastZeroShareVolumeMarkdown(result))}</p></section>
    ...
    <section class="print-only print-keep"><h2>First zero-share volume-to-hold</h2><p>${escapeAttribute(firstZeroShareVolumeMarkdown(result))}</p></section>
    ...
    ${firstOverCapacityVolumeCopySection()}
    ...
    ${lastZeroShareVolumeCopySection()}
    ${firstZeroShareRemainingCopySection()}
    ${firstZeroShareVolumeCopySection()}
...
function attachEvents() {
  ...
  app.addEventListener('click', (event) => {
    ...
    if (action === 'close-first-over-capacity-volume-copy') { firstOverCapacityVolumeCopyText = ''; render(); return; }
    ...
    if (action === 'close-last-zero-share-volume-copy') { lastZeroShareVolumeCopyText = ''; render(); return; }
    if (action === 'close-first-zero-share-remaining-copy') { firstZeroShareRemainingCopyText = ''; render(); return; }
    if (action === 'close-first-zero-share-volume-copy') { firstZeroShareVolumeCopyText = ''; render(); return; }
    ...
    if (action === 'copy-first-over-capacity-volume') copyFirstOverCapacityVolume();
    ...
    if (action === 'copy-last-zero-share-volume') copyLastZeroShareVolume();
    if (action === 'copy-first-zero-share-remaining') copyFirstZeroShareRemaining();
    if (action === 'copy-first-zero-share-volume') copyFirstZeroShareVolume();
...
function lastZeroShareVolumeMarkdown(result) {
  let participant = null;
  for (const item of state.participants) {
    if (participantHasZeroShare(item)) participant = item;
  }
  if (!participant) return 'Last zero-share volume-to-hold: none entered.';
  const named = result?.participants.find((item) => item.id === participant.id);
  const volume = named?.exitVolume;
  if (volume == null || !Number.isFinite(volume)) {
    return 'Last zero-share volume-to-hold: volume to hold is not a finite amount for ' + reportText(named?.name ?? participant.name) + '. Volume to hold. Not a forecast.';
  }
  return 'Last zero-share volume-to-hold: ' + formatVolume(volume) + ' for ' + reportText(named?.name ?? participant.name) + '. Volume to hold. Not a forecast.';
}

function showLastZeroShareVolumeCopyFallback(text, message) {
  lastZeroShareVolumeCopyText = text;
  render();
  document.querySelector('#last-zero-share-volume-copy-text')?.focus();
  setNotice(message);
}

function lastZeroShareVolumeCopySection() {
  if (!lastZeroShareVolumeCopyText) return '';
  return `<section class="panel" aria-labelledby="last-zero-share-volume-copy-title"><div class="panel-heading"><h2 id="last-zero-share-volume-copy-title">Last zero-share volume-to-hold Markdown</h2><button type="button" data-action="close-last-zero-share-volume-copy">Close</button></div><div class="panel-body"><p>Clipboard is unavailable in this browser. Select the Markdown below and copy it. This is volume to hold for the last roster row with zero revenue share. It is distinct from last zero-share remaining-to-hold copy, first zero-share remaining-to-hold copy, first zero-share volume-to-hold copy, first zero-share participant label copy, last zero-share participant label copy, and first-breakpoint volume-to-hold copy. It is organizer or planner copy, not a forecast of who will exit.</p><label class="brief-copy-label" for="last-zero-share-volume-copy-text">Last zero-share volume-to-hold Markdown</label><textarea id="last-zero-share-volume-copy-text" readonly rows="4">${escapeAttribute(lastZeroShareVolumeCopyText)}</textarea></div></section>`;
}

function copyLastZeroShareVolume() {
  const validation = validateConfiguration(state);
  const result = validation.valid ? calculatePartnership(state) : null;
  const text = lastZeroShareVolumeMarkdown(result);
  const clipboard = globalThis.navigator?.clipboard;
  const copiedNote = 'Last zero-share volume-to-hold copied as Markdown. Volume to hold. It is organizer or planner copy, not a forecast of who will exit.';
  const fallbackNote = 'Clipboard unavailable. Copy the Markdown from the text area.';
  if (clipboard && typeof clipboard.writeText === 'function') {
    try {
      const written = clipboard.writeText(text);
      if (written && typeof written.then === 'function') {
        written.then(() => {
          ...
          showLastZeroShareVolumeCopyFallback(text, fallbackNote);
        });
        return;
      }
      lastZeroShareVolumeCopyText = '';
...
function firstZeroShareRemainingCopySection() {
  ...
  return `<section class="panel" aria-labelledby="first-zero-share-remaining-copy-title"><div class="panel-heading"><h2 id="first-zero-share-remaining-copy-title">First zero-share remaining-to-hold Markdown</h2><button type="button" data-action="close-first-zero-share-remaining-copy">Close</button></div><div class="panel-body"><p>Clipboard is unavailable in this browser. Select the Markdown below and copy it. This is remaining to hold for the first roster row with zero revenue share. It is distinct from first zero-share participant label copy, last zero-share participant label copy, last zero-share remaining-to-hold copy, first zero-share volume-to-hold copy, last zero-share volume-to-hold copy, first at-hold remaining-to-hold copy, last at-hold remaining-to-hold copy, last unbounded remaining-to-hold copy, and first unbounded remaining-to-hold copy. It is organizer or planner copy, not a forecast of who will exit.</p><label class="brief-copy-label" for="first-zero-share-remaining-copy-text">First zero-share remaining-to-hold Markdown</label><textarea id="first-zero-share-remaining-copy-text" readonly rows="4">${escapeAttribute(firstZeroShareRemainingCopyText)}</textarea></div></section>`;
}
...
function firstZeroShareVolumeMarkdown(result) {
  const participant = state.participants.find((item) => participantHasZeroShare(item));
  if (!participant) return 'First zero-share volume-to-hold: none entered.';
  const named = result?.participants.find((item) => item.id === participant.id);
  const volume = named?.exitVolume;
  if (volume == null || !Number.isFinite(volume)) {
    return 'First zero-share volume-to-hold: volume to hold is not a finite amount for ' + reportText(named?.name ?? participant.name) + '. Volume to hold. Not a forecast.';
  }
  return 'First zero-share volume-to-hold: ' + formatVolume(volume) + ' for ' + reportText(named?.name ?? participant.name) + '. Volume to hold. Not a forecast.';
}

function showFirstZeroShareVolumeCopyFallback(text, message) {
  firstZeroShareVolumeCopyText = text;
  render();
  document.querySelector('#first-zero-share-volume-copy-text')?.focus();
  setNotice(message);
}

function firstZeroShareVolumeCopySection() {
  if (!firstZeroShareVolumeCopyText) return '';
  return `<section class="panel" aria-labelledby="first-zero-share-volume-copy-title"><div class="panel-heading"><h2 id="first-zero-share-volume-copy-title">First zero-share volume-to-hold Markdown</h2><button type="button" data-action="close-first-zero-share-volume-copy">Close</button></div><div class="panel-body"><p>Clipboard is unavailable in this browser. Select the Markdown below and copy it. This is volume to hold for the first roster row with zero revenue share. It is distinct from last zero-share volume-to-hold copy, last zero-share remaining-to-hold copy, first zero-share remaining-to-hold copy, first zero-share participant label copy, last zero-share participant label copy, and first-breakpoint volume-to-hold copy. It is organizer or planner copy, not a forecast of who will exit.</p><label class="brief-copy-label" for="first-zero-share-volume-copy-text">First zero-share volume-to-hold Markdown</label><textarea id="first-zero-share-volume-copy-text" readonly rows="4">${escapeAttribute(firstZeroShareVolumeCopyText)}</textarea></div></section>`;
}

function copyFirstZeroShareVolume() {
  const validation = validateConfiguration(state);
  const result = validation.valid ? calculatePartnership(state) : null;
  const text = firstZeroShareVolumeMarkdown(result);
  const clipboard = globalThis.navigator?.clipboard;
  const copiedNote = 'First zero-share volume-to-hold copied as Markdown. Volume to hold. It is organizer or planner copy, not a forecast of who will exit.';
  const fallbackNote = 'Clipboard unavailable. Copy the Markdown from the text area.';
  if (clipboard && typeof clipboard.writeText === 'function') {
    try {
      const written = clipboard.writeText(text);
      if (written && typeof written.then === 'function') {
        written.then(() => {
          ...
          showFirstZeroShareVolumeCopyFallback(text, fallbackNote);
        });
        return;
      }
      firstZeroShareVolumeCopyText = '';
