...
Version 1.4.3 adds participant CSV export, keyboard `n` and `s`, tornado SVG download, imported-JSON compare, duplicate-name warnings, pasted TSV or CSV roster import, redacted print, copy of visible stress-grid CSV, and a Four-party marketplace starting point. Counts remain counts. The workbench does not assign probabilities.
