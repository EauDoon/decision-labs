...
`restoreExampleOffers` replaces offers with a named preset's offers and keeps the current buyers, title, and currency. Named lunch presets include Lead-out cycling carnival lunch after Feed-zone cycling carnival lunch after First-aid cycling carnival lunch after Team-sprint cycling carnival lunch after Team-pursuit cycling carnival lunch after Individual-pursuit cycling carnival lunch after Scratch cycling carnival lunch after Points-race cycling carnival lunch after Omnium cycling carnival lunch after Madison cycling carnival lunch. Lead-out leftover uncovered leftover-only remaining is 51 leftover-only units. Pickup minimum 49, unit price 46, capacity 64. Leftover-only minimum stays 15. Distinct from Feed-zone leftover remaining 49, First-aid leftover remaining 47, Team-sprint leftover remaining 45, Team-pursuit leftover remaining 43, Individual-pursuit leftover remaining 41, and Scratch leftover remaining 39.
