...
`restoreExampleOffers` replaces offers with a named preset's offers and keeps the current buyers, title, and currency. Named lunch presets include Team-pursuit cycling carnival lunch after Individual-pursuit cycling carnival lunch after Scratch cycling carnival lunch after Points-race cycling carnival lunch after Omnium cycling carnival lunch after Madison cycling carnival lunch. Team-pursuit leftover uncovered leftover-only remaining is 43 leftover-only units. Pickup minimum 42, unit price 38, capacity 64. Leftover-only minimum stays 15. Distinct from Individual-pursuit leftover remaining 41 and Scratch leftover remaining 39.
