...
`restoreExampleOffers` replaces offers with a named preset's offers and keeps the current buyers, title, and currency. Named lunch presets include Team-sprint cycling carnival lunch after Team-pursuit cycling carnival lunch after Individual-pursuit cycling carnival lunch after Scratch cycling carnival lunch after Points-race cycling carnival lunch after Omnium cycling carnival lunch after Madison cycling carnival lunch. Team-sprint leftover uncovered leftover-only remaining is 45 leftover-only units. Pickup minimum 43, unit price 40, capacity 64. Leftover-only minimum stays 15. Distinct from Team-pursuit leftover remaining 43, Individual-pursuit leftover remaining 41, and Scratch leftover remaining 39.
