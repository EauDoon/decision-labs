...
`restoreExampleOffers` replaces offers with a named preset's offers and keeps the current buyers, title, and currency. Named lunch presets include Feed-zone cycling carnival lunch after First-aid cycling carnival lunch after Team-sprint cycling carnival lunch after Team-pursuit cycling carnival lunch after Individual-pursuit cycling carnival lunch after Scratch cycling carnival lunch after Points-race cycling carnival lunch after Omnium cycling carnival lunch after Madison cycling carnival lunch. Feed-zone leftover uncovered leftover-only remaining is 49 leftover-only units. Pickup minimum 47, unit price 44, capacity 64. Leftover-only minimum stays 15. Distinct from First-aid leftover remaining 47, Team-sprint leftover remaining 45, Team-pursuit leftover remaining 43, Individual-pursuit leftover remaining 41, and Scratch leftover remaining 39.
