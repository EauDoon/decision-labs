...
test("the organizer hide-leftover-only-buyers filter is not on the merchant table", async () => {
  ...
  assert.match(html, /hide-leftover-only-buyers, hide-winner-allocated-buyers, hide-buyers-filled-by-leftover-fill, and hide-last-buyer-filled-by-leftover-fill choices are kept/u);
