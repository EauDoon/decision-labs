...
test("Shift+F8 leftover uncovered leftover-only allocated copy jump stays on the organizer leftover uncovered leftover-only allocated control", async () => {
  ...
  assert.match(html, /<kbd>Shift\+F8<\/kbd> Focus the leftover uncovered leftover-only allocated copy control, or leftover heading if missing/u);
