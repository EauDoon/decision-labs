...
test("Shift+F8 leftover uncovered leftover-only unit price copy jump stays on the organizer leftover uncovered leftover-only unit price control", async () => {
  ...
  assert.match(html, /<kbd>Shift\+F8<\/kbd> Focus the leftover uncovered leftover-only unit price copy control, or leftover heading if missing/u);
