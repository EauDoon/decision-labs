...
test("Shift+F7 leftover uncovered leftover-only unit price copy uses the leftover uncovered leftover-only unit price control", async () => {
  ...
  assert.match(html, /<kbd>Shift\+F7<\/kbd> Copy leftover uncovered leftover-only unit price \(organizer private\)/u);
