...
test("new presets survive validation and keep a deterministic winner", () => {
  for (const name of ["officePantry", "hardware", "garden", "schoolFete", "officeFruit", "libraryPaper", "sportsKit", "surfFirstAid", "theatreWardrobe", "choirFolders", "scoutCamp", "schoolExcursionLunch", "netballCanteen", "swimmingCarnivalLunch", "athleticsCarnivalLunch", "cricketCarnivalLunch", "tennisCarnivalLunch", "basketballCarnivalLunch", "volleyballCarnivalLunch", "soccerCarnivalLunch", "rugbyCarnivalLunch", "hockeyCarnivalLunch", "baseballCarnivalLunch", "softballCarnivalLunch", "waterPoloCarnivalLunch", "rowingCarnivalLunch", "sailingCarnivalLunch", "canoeingCarnivalLunch", "kayakingCarnivalLunch", "dragonBoatCarnivalLunch"]) {
