...
export const DEFAULT_SCENARIO = Object.freeze({
  ...
  saturdayEarlyFxOpen: false,
  sundayLateBankClose: false,
  sundayLatePayoutClose: false,
  ...
  sundayEarlyIssuerOpen: false,
  saturdayEarlyIssuerOpen: false,
  fridayEarlyIssuerOpen: false,
  saturdayEarlyBankOpen: false,
  fridayEarlyBankOpen: false,
  saturdayLateBankOpen: false,
...
export const PRESETS = Object.freeze({
  ...
  sundayStallClose: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday stall close (synthetic)",
    demandProfile: "sundayBurst",
    payoutOpenEndHour: 16,
  ...
  mondayLateIssuerOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Monday late issuer open (synthetic)",
    issuerOpenStartHour: 9
  }),
  saturdayEarlyFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday early FX open (synthetic)",
    saturdayEarlyFxOpen: true
  }),
  sundayLateBankClose: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday late bank close (synthetic)",
    sundayLateBankClose: true
  }),
  sundayLatePayoutClose: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday late payout close (synthetic)",
    sundayLatePayoutClose: true
  }),
  saturdayEarlyPayoutOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday early payout open (synthetic)",
    saturdayEarlyPayoutOpen: true
  }),
  fridayEarlyPayoutOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday early payout open (synthetic)",
    fridayEarlyPayoutOpen: true
  }),
  saturdayLatePayoutOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday late payout open (synthetic)",
    saturdayLatePayoutOpen: true
  }),
  sundayEarlyPayoutOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
  ...
  sundayEarlyIssuerOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday early issuer open (synthetic)",
    sundayEarlyIssuerOpen: true
  }),
  saturdayEarlyIssuerOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday early issuer open (synthetic)",
    saturdayEarlyIssuerOpen: true
  }),
  fridayEarlyIssuerOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday early issuer open (synthetic)",
    fridayEarlyIssuerOpen: true
  }),
  saturdayEarlyBankOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday early bank open (synthetic)",
    saturdayEarlyBankOpen: true
  }),
  fridayEarlyBankOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday early bank open (synthetic)",
    fridayEarlyBankOpen: true
  }),
  saturdayLateBankOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday late bank open (synthetic)",
    saturdayLateBankOpen: true
  }),
  fridayLateBankOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday late bank open (synthetic)",
    fridayLateBankOpen: true
  }),
  fridayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday late FX open (synthetic)",
    fridayLateFxOpen: true
  }),
  saturdayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday late FX open (synthetic)",
    saturdayLateFxOpen: true
  }),
  sundayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday late FX open (synthetic)",
    sundayLateFxOpen: true
  }),
  sundayEarlyFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday early FX open (synthetic)",
    sundayEarlyFxOpen: true
  }),
  mondayEarlyFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Monday early FX open (synthetic)",
    mondayEarlyFxOpen: true
  }),
  mondayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
  ...
  tuesdayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
  ...
  wednesdayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Wednesday late FX open (synthetic)",
    wednesdayLateFxOpen: true
  }),
  thursdayEarlyFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Thursday early FX open (synthetic)",
    thursdayEarlyFxOpen: true
  }),
  thursdayLateFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Thursday late FX open (synthetic)",
    thursdayLateFxOpen: true
  }),
  fridayEarlyFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Friday early FX open (synthetic)",
    fridayEarlyFxOpen: true
  }),
  saturdayMiddayFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday midday FX open (synthetic)",
    saturdayMiddayFxOpen: true
  }),
  sundayMiddayFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday midday FX open (synthetic)",
    sundayMiddayFxOpen: true
  }),
  saturdayAfternoonFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday afternoon FX open (synthetic)",
    saturdayAfternoonFxOpen: true
  }),
  sundayAfternoonFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday afternoon FX open (synthetic)",
    sundayAfternoonFxOpen: true
  }),
  sundayMorningFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday morning FX open (synthetic)",
    sundayMorningFxOpen: true
  }),
  saturdayEveningFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Saturday evening FX open (synthetic)",
    saturdayEveningFxOpen: true
  }),
  sundayEveningFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday evening FX open (synthetic)",
    sundayEveningFxOpen: true
  }),
  sundayNightFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday night FX open (synthetic)",
    sundayNightFxOpen: true
  }),
  sundayLateNightFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday late-night FX open (synthetic)",
    sundayLateNightFxOpen: true
  }),
  saturdayNightFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
  ...
  sundayPredawnFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday predawn FX open (synthetic)",
    sundayPredawnFxOpen: true
  }),
  sundayDawnFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday dawn FX open (synthetic)",
    sundayDawnFxOpen: true
  }),
  sundayDaybreakFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday daybreak FX open (synthetic)",
    sundayDaybreakFxOpen: true
  }),
  sundaySunriseFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday sunrise FX open (synthetic)",
    sundaySunriseFxOpen: true
  }),
  sundayBreakfastFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday breakfast FX open (synthetic)",
    sundayBreakfastFxOpen: true
  }),
  sundayBrunchFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday brunch FX open (synthetic)",
    sundayBrunchFxOpen: true
  }),
  sundayLunchFxOpen: Object.freeze({
    ...DEFAULT_SCENARIO,
    name: "Sunday lunch FX open (synthetic)",
    sundayLunchFxOpen: true
  })
});

const FIELD_RULES = Object.freeze({
  name: { type: "text", maxLength: 80 },
  horizonHours: { min: MIN_HORIZON_HOURS, max: MAX_HORIZON_HOURS, integer: true },
  ...
  demandProfile: { type: "choice", values: ["flat", "fridayBurst", "mondayRush", "saturdayBurst", "sundayBurst"] },
  ...
  saturdayEarlyFxOpen: { type: "boolean" },
  sundayLateBankClose: { type: "boolean" },
  sundayLatePayoutClose: { type: "boolean" },
  ...
  sundayEarlyIssuerOpen: { type: "boolean" },
  saturdayEarlyIssuerOpen: { type: "boolean" },
  fridayEarlyIssuerOpen: { type: "boolean" },
  saturdayEarlyBankOpen: { type: "boolean" },
  fridayEarlyBankOpen: { type: "boolean" },
  saturdayLateBankOpen: { type: "boolean" },
  fridayLateBankOpen: { type: "boolean" },
  fridayLateFxOpen: { type: "boolean" },
  saturdayLateFxOpen: { type: "boolean" },
  sundayLateFxOpen: { type: "boolean" },
  sundayEarlyFxOpen: { type: "boolean" },
  ...
  wednesdayLateFxOpen: { type: "boolean" },
  thursdayEarlyFxOpen: { type: "boolean" },
  thursdayLateFxOpen: { type: "boolean" },
  fridayEarlyFxOpen: { type: "boolean" },
  saturdayMiddayFxOpen: { type: "boolean" },
  sundayMiddayFxOpen: { type: "boolean" },
  saturdayAfternoonFxOpen: { type: "boolean" },
  sundayAfternoonFxOpen: { type: "boolean" },
  sundayMorningFxOpen: { type: "boolean" },
  saturdayEveningFxOpen: { type: "boolean" },
  ...
  sundayPredawnFxOpen: { type: "boolean" },
  sundayDawnFxOpen: { type: "boolean" },
  sundayDaybreakFxOpen: { type: "boolean" },
  sundaySunriseFxOpen: { type: "boolean" },
  sundayBreakfastFxOpen: { type: "boolean" },
  sundayBrunchFxOpen: { type: "boolean" },
  sundayLunchFxOpen: { type: "boolean" }
});
...
export function sanitizeScenario(raw = {}) {
  ...
  const overrides = sanitizeCalendarOverrides(source.calendarOverrides, scenario.horizonHours);
  if (overrides.errors.length) {
    errors.push(...overrides.errors);
  } else if (source.calendarOverrides !== undefined) {
...
/** Validated simulation horizon in whole hours. Sanitized scenarios always carry one. */
export function scenarioHours(scenarioInput) {
  const scenario = scenarioInput && typeof scenarioInput === "object" ? scenarioInput : {};
  const hours = scenario.horizonHours;
  if (Number.isInteger(hours) && hours >= MIN_HORIZON_HOURS && hours <= MAX_HORIZON_HOURS) return hours;
  return SIMULATION_HOURS;
}

/**
 * Validates explicit dated operating-window overrides. Each override names a
 * half-open hour range [startHour, endHour) inside the horizon plus any subset
 * of gate states and throughput changes. Overlapping ranges are allowed;
 * later entries win per field. Ranges outside the horizon are rejected, not
 * clamped, so a horizon change cannot silently reinterpret saved overrides.
 */
export function sanitizeCalendarOverrides(raw, horizon) {
  const errors = [];
  if (raw === undefined) return { overrides: undefined, errors };
  if (!Array.isArray(raw)) return { overrides: undefined, errors: ["Calendar overrides must be an array."] };
  if (raw.length > MAX_CALENDAR_OVERRIDES) {
    return { overrides: undefined, errors: [`Calendar overrides allow at most ${MAX_CALENDAR_OVERRIDES} entries.`] };
  }
  const limit = Number.isInteger(horizon) && horizon >= MIN_HORIZON_HOURS && horizon <= MAX_HORIZON_HOURS ? horizon : SIMULATION_HOURS;
  const gates = ["issuer", "bank", "payout"];
  const overrides = [];
  raw.forEach((entry, index) => {
    const prefix = `Calendar override ${index + 1}`;
    if (!entry || typeof entry !== "object" || Array.isArray(entry)) {
      errors.push(`${prefix} must be an object.`);
      return;
    }
    for (const key of Object.keys(entry)) {
      if (!["startHour", "endHour", "gates", "fx", "throughput"].includes(key)) {
        errors.push(`${prefix} has unexpected field: ${key}.`);
      }
    }
    const startHour = entry.startHour;
    const endHour = entry.endHour;
    if (!Number.isInteger(startHour) || startHour < 0 || startHour >= limit) {
      errors.push(`${prefix} start hour must be a whole hour from 0 through ${limit - 1}.`);
    }
    if (!Number.isInteger(endHour) || endHour <= 0 || endHour > limit) {
      errors.push(`${prefix} end hour must be a whole hour from 1 through ${limit}.`);
    }
    if (Number.isInteger(startHour) && Number.isInteger(endHour) && startHour < limit && endHour <= limit && startHour >= endHour) {
      errors.push(`${prefix} must end after it starts.`);
    }
    const normalized = { startHour, endHour };
    if (entry.gates !== undefined) {
      if (!entry.gates || typeof entry.gates !== "object" || Array.isArray(entry.gates)) {
        errors.push(`${prefix} gates must be an object.`);
      } else {
        normalized.gates = {};
        for (const key of Object.keys(entry.gates)) {
          if (!gates.includes(key)) errors.push(`${prefix} gates has unexpected gate: ${key}.`);
          else if (entry.gates[key] !== "open" && entry.gates[key] !== "closed") errors.push(`${prefix} gate ${key} must be open or closed.`);
          else normalized.gates[key] = entry.gates[key];
        }
      }
    }
    if (entry.fx !== undefined) {
      if (entry.fx !== "weekday" && entry.fx !== "weekend") errors.push(`${prefix} FX must be weekday or weekend.`);
      else normalized.fx = entry.fx;
    }
    if (entry.throughput !== undefined) {
      if (!entry.throughput || typeof entry.throughput !== "object" || Array.isArray(entry.throughput)) {
        errors.push(`${prefix} throughput must be an object.`);
      } else {
        normalized.throughput = {};
        for (const key of ["issuer", "fx", "payout"]) {
          if (entry.throughput[key] === undefined) continue;
          if (typeof entry.throughput[key] !== "number" || !Number.isFinite(entry.throughput[key]) || entry.throughput[key] < 0 || entry.throughput[key] > 1000000000) {
            errors.push(`${prefix} ${key} throughput must be finite from 0 through 1,000,000,000.`);
          } else {
            normalized.throughput[key] = entry.throughput[key];
          }
        }
        for (const key of Object.keys(entry.throughput)) {
          if (!["issuer", "fx", "payout"].includes(key)) errors.push(`${prefix} throughput has unexpected field: ${key}.`);
        }
      }
    }
    overrides.push(normalized);
  });
  if (errors.length) return { overrides: undefined, errors };
  return { overrides: Object.freeze(overrides.map((entry) => Object.freeze(entry))), errors };
}

/**
 * Merged override in force at one hour offset. Later entries win per field,
 * so a dated closure can carry a narrower reopening inside it.
 */
export function overrideAtHour(scenarioInput, hourOffset) {
  ...
  const merged = { gates: {}, fx: null, throughput: {} };
  let found = false;
  for (const entry of overrides) {
    if (hour < entry.startHour || hour >= entry.endHour) continue;
    found = true;
    for (const [gate, state] of Object.entries(entry.gates ?? {})) merged.gates[gate] = state;
    if (entry.fx !== undefined) merged.fx = entry.fx;
...
export function throughputAtHour(scenarioInput, hourOffset) {
  const { scenario } = sanitizeScenario(scenarioInput);
  const override = overrideAtHour(scenario, hourOffset)?.throughput ?? {};
  return {
    issuer: override.issuer ?? scenario.issuerThroughputAudPerHour,
    fx: override.fx ?? scenario.fxDepthAudPerHour,
    payout: override.payout ?? scenario.payoutThroughputAudPerHour,
  };
}
...
/** Saturday 06:00-11:00 keeps weekday FX depth when Saturday early FX open is on. */
function isSaturdayEarlyFxHour(hourOffset, scenario) {
  if (scenario.saturdayEarlyFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 6 && localHour < 12;
}

/** Sunday 16:00-18:00 keeps the bank gate open when Sunday late bank close is on. */
function isSundayLateBankHour(hourOffset, scenario) {
  if (scenario.sundayLateBankClose !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 16 && localHour < 18;
}

/** Sunday 16:00-18:00 keeps the payout gate open when Sunday late payout close is on. */
function isSundayLatePayoutHour(hourOffset, scenario) {
  if (scenario.sundayLatePayoutClose !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 16 && localHour < 18;
}

/** Saturday 07:00-09:00 keeps the payout gate open when Saturday early payout open is on. */
function isSaturdayEarlyPayoutHour(hourOffset, scenario) {
  if (scenario.saturdayEarlyPayoutOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 7 && localHour < 9;
}

/** Friday 18:00-20:00 keeps the payout gate open when Friday early payout open is on. */
function isFridayEarlyPayoutHour(hourOffset, scenario) {
  if (scenario.fridayEarlyPayoutOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 5 && localHour >= 18 && localHour < 20;
}

/** Saturday 18:00-20:00 keeps the payout gate open when Saturday late payout open is on. */
function isSaturdayLatePayoutHour(hourOffset, scenario) {
  if (scenario.saturdayLatePayoutOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 18 && localHour < 20;
}

/** Sunday 08:00-10:00 keeps the payout gate open when Sunday early payout open is on. */
function isSundayEarlyPayoutHour(hourOffset, scenario) {
  if (scenario.sundayEarlyPayoutOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
...
/** Sunday 08:00-10:00 keeps the issuer gate open when Sunday early issuer open is on. */
function isSundayEarlyIssuerHour(hourOffset, scenario) {
  if (scenario.sundayEarlyIssuerOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 8 && localHour < 10;
}

/** Saturday 08:00-10:00 keeps the issuer gate open when Saturday early issuer open is on. */
function isSaturdayEarlyIssuerHour(hourOffset, scenario) {
  if (scenario.saturdayEarlyIssuerOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 8 && localHour < 10;
}

/** Friday 08:00-10:00 keeps the issuer gate open when Friday early issuer open is on. */
function isFridayEarlyIssuerHour(hourOffset, scenario) {
  if (scenario.fridayEarlyIssuerOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 5 && localHour >= 8 && localHour < 10;
}

/** Saturday 08:00-10:00 keeps the bank gate open when Saturday early bank open is on. */
function isSaturdayEarlyBankHour(hourOffset, scenario) {
  if (scenario.saturdayEarlyBankOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 8 && localHour < 10;
}

/** Friday 08:00-10:00 keeps the bank gate open when Friday early bank open is on. */
function isFridayEarlyBankHour(hourOffset, scenario) {
  if (scenario.fridayEarlyBankOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 5 && localHour >= 8 && localHour < 10;
}

/** Saturday 16:00-18:00 keeps the bank gate open when Saturday late bank open is on. */
function isSaturdayLateBankHour(hourOffset, scenario) {
  if (scenario.saturdayLateBankOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 16 && localHour < 18;
}

/** Friday 16:00-18:00 keeps the bank gate open when Friday late bank open is on. */
function isFridayLateBankHour(hourOffset, scenario) {
  if (scenario.fridayLateBankOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 5 && localHour >= 16 && localHour < 18;
}

/** Friday 16:00-18:00 keeps weekday FX depth when Friday late FX open is on. Distinct from isFridayLateFxHour (Saturday 00:00 delayed Friday FX close). */
function isFridayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.fridayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 5 && localHour >= 16 && localHour < 18;
}

/** Saturday 16:00-18:00 keeps weekday FX depth when Saturday late FX open is on. Distinct from saturdayAfternoonFxOpen (Sat 14:00-16:00), saturdayMiddayFxOpen (Sat 12:00-14:00), saturdayLateBankOpen, saturdayLatePayoutOpen, saturdayEarlyFxOpen, and fridayLateFxOpen. */
function isSaturdayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.saturdayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 16 && localHour < 18;
}

/** Sunday 16:00-18:00 keeps weekday FX depth when Sunday late FX open is on. Distinct from saturdayLateFxOpen, fridayLateFxOpen, saturdayLateBankOpen, saturdayLatePayoutOpen, sundayLateIssuerClose, sundayLatePayoutClose, and sundayLateBankClose. */
function isSundayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 16 && localHour < 18;
}

/** Sunday 08:00-10:00 keeps weekday FX depth when Sunday early FX open is on. Distinct from isSundayLateFxOpenHour (Sun 16:00-18:00), saturdayLateFxOpen, fridayLateFxOpen, sundayEarlyPayoutOpen, and sundayEarlyIssuerOpen. */
function isSundayEarlyFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayEarlyFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 8 && localHour < 10;
}

/** Monday 08:00-10:00 keeps weekday FX depth when Monday early FX open is on. Distinct from sundayEarlyFxOpen (Sun 08:00-10:00) and fridayLateFxOpen (Fri 16:00-18:00). */
function isMondayEarlyFxOpenHour(hourOffset, scenario) {
  if (scenario.mondayEarlyFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 1 && localHour >= 8 && localHour < 10;
}

/** Monday 16:00-18:00 keeps weekday FX depth when Monday late FX open is on. Distinct from isMondayEarlyFxOpenHour (Mon 08:00-10:00), fridayLateFxOpen (Fri 16:00-18:00), sundayEarlyFxOpen (Sun 08:00-10:00), and saturdayLateFxOpen (Sat 16:00-18:00). */
function isMondayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.mondayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 1 && localHour >= 16 && localHour < 18;
}

/** Tuesday 08:00-10:00 keeps weekday FX depth when Tuesday early FX open is on. Distinct from mondayEarlyFxOpen (Mon 08:00-10:00), mondayLateFxOpen (Mon 16:00-18:00), fridayLateFxOpen (Fri 16:00-18:00), sundayEarlyFxOpen (Sun 08:00-10:00), and saturdayLateFxOpen (Sat 16:00-18:00). */
function isTuesdayEarlyFxOpenHour(hourOffset, scenario) {
  if (scenario.tuesdayEarlyFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 2 && localHour >= 8 && localHour < 10;
}

/** Tuesday 16:00-18:00 keeps weekday FX depth when Tuesday late FX open is on. Distinct from isTuesdayEarlyFxOpenHour (Tue 08:00-10:00), mondayLateFxOpen (Mon 16:00-18:00), mondayEarlyFxOpen, fridayLateFxOpen, sundayEarlyFxOpen, saturdayLateFxOpen, wednesdayEarlyFxOpen, wednesdayLateFxOpen, thursdayEarlyFxOpen, and thursdayLateFxOpen. */
function isTuesdayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.tuesdayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 2 && localHour >= 16 && localHour < 18;
}

/** Wednesday 08:00-10:00 keeps weekday FX depth when Wednesday early FX open is on. Distinct from tuesdayLateFxOpen (Tue 16:00-18:00), tuesdayEarlyFxOpen (Tue 08:00-10:00), mondayLateFxOpen, mondayEarlyFxOpen, fridayLateFxOpen, sundayEarlyFxOpen, saturdayLateFxOpen, wednesdayLateFxOpen, thursdayEarlyFxOpen, and thursdayLateFxOpen. */
...
/** Wednesday 16:00-18:00 keeps weekday FX depth when Wednesday late FX open is on. Distinct from wednesdayEarlyFxOpen (Wed 08:00-10:00), tuesdayLateFxOpen (Tue 16:00-18:00), tuesdayEarlyFxOpen (Tue 08:00-10:00), mondayLateFxOpen, mondayEarlyFxOpen, fridayLateFxOpen, sundayEarlyFxOpen, saturdayLateFxOpen, thursdayEarlyFxOpen, and thursdayLateFxOpen. */
function isWednesdayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.wednesdayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 3 && localHour >= 16 && localHour < 18;
}

/** Thursday 08:00-10:00 keeps weekday FX depth when Thursday early FX open is on. Distinct from thursdayLateFxOpen (Thu 16:00-18:00), wednesdayLateFxOpen (Wed 16:00-18:00), wednesdayEarlyFxOpen (Wed 08:00-10:00), tuesdayLateFxOpen (Tue 16:00-18:00), tuesdayEarlyFxOpen (Tue 08:00-10:00), mondayLateFxOpen, mondayEarlyFxOpen, fridayLateFxOpen, sundayEarlyFxOpen, and saturdayLateFxOpen. */
function isThursdayEarlyFxOpenHour(hourOffset, scenario) {
  if (scenario.thursdayEarlyFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 4 && localHour >= 8 && localHour < 10;
}

/** Thursday 16:00-18:00 keeps weekday FX depth when Thursday late FX open is on. Distinct from thursdayEarlyFxOpen (Thu 08:00-10:00), wednesdayLateFxOpen (Wed 16:00-18:00), wednesdayEarlyFxOpen (Wed 08:00-10:00), tuesdayLateFxOpen (Tue 16:00-18:00), tuesdayEarlyFxOpen (Tue 08:00-10:00), mondayLateFxOpen, mondayEarlyFxOpen, fridayLateFxOpen, sundayEarlyFxOpen, saturdayLateFxOpen, and fridayEarlyFxOpen. */
function isThursdayLateFxOpenHour(hourOffset, scenario) {
  if (scenario.thursdayLateFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
...
/** Saturday 12:00-14:00 keeps weekday FX depth when Saturday midday FX open is on. Distinct from saturdayAfternoonFxOpen (Sat 14:00-16:00), saturdayEarlyFxOpen (Sat 06:00-11:00), saturdayLateFxOpen (Sat 16:00-18:00), fridayEarlyFxOpen (Fri 08:00-10:00), fridayLateFxOpen, sundayEarlyFxOpen, sundayMiddayFxOpen, saturdayEarlyIssuerOpen, saturdayEarlyBankOpen, and saturdayEarlyPayoutOpen. */
function isSaturdayMiddayFxOpenHour(hourOffset, scenario) {
  if (scenario.saturdayMiddayFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 12 && localHour < 14;
}

/** Sunday 12:00-14:00 keeps weekday FX depth when Sunday midday FX open is on. Distinct from saturdayAfternoonFxOpen (Sat 14:00-16:00), saturdayMiddayFxOpen (Sat 12:00-14:00), sundayEarlyFxOpen (Sun 08:00-10:00), sundayLateFxOpen (Sun 16:00-18:00), saturdayEarlyFxOpen (Sat 06:00-11:00), saturdayLateFxOpen (Sat 16:00-18:00), fridayEarlyFxOpen, and fridayLateFxOpen. */
function isSundayMiddayFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayMiddayFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 12 && localHour < 14;
}

/** Saturday 14:00-16:00 keeps weekday FX depth when Saturday afternoon FX open is on. Distinct from saturdayMiddayFxOpen (Sat 12:00-14:00), saturdayLateFxOpen (Sat 16:00-18:00), saturdayEarlyFxOpen (Sat 06:00-11:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayEarlyFxOpen, sundayLateFxOpen, fridayEarlyFxOpen, and fridayLateFxOpen. */
function isSaturdayAfternoonFxOpenHour(hourOffset, scenario) {
  if (scenario.saturdayAfternoonFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 14 && localHour < 16;
}

/** Sunday 14:00-16:00 keeps weekday FX depth when Sunday afternoon FX open is on. Distinct from saturdayAfternoonFxOpen (Sat 14:00-16:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayLateFxOpen (Sun 16:00-18:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayMiddayFxOpen, saturdayLateFxOpen, fridayEarlyFxOpen, and fridayLateFxOpen. */
function isSundayAfternoonFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayAfternoonFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 14 && localHour < 16;
}

/** Sunday 10:00-12:00 keeps weekday FX depth when Sunday morning FX open is on. Distinct from sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayEarlyFxOpen (Sun 08:00-10:00), sundayLateFxOpen (Sun 16:00-18:00), saturdayAfternoonFxOpen (Sat 14:00-16:00), saturdayEveningFxOpen (Sat 18:00-20:00), saturdayMiddayFxOpen, saturdayLateFxOpen, fridayEarlyFxOpen, and fridayLateFxOpen. */
function isSundayMorningFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayMorningFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 10 && localHour < 12;
}

/** Saturday 18:00-20:00 keeps weekday FX depth when Saturday evening FX open is on. Distinct from sundayMorningFxOpen (Sun 10:00-12:00), saturdayLateFxOpen (Sat 16:00-18:00), saturdayAfternoonFxOpen (Sat 14:00-16:00), saturdayMiddayFxOpen (Sat 12:00-14:00), saturdayEarlyFxOpen (Sat 06:00-11:00), sundayAfternoonFxOpen, sundayMiddayFxOpen, sundayLateFxOpen, sundayEveningFxOpen (Sun 18:00-20:00), sundayNightFxOpen (Sun 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSaturdayEveningFxOpenHour(hourOffset, scenario) {
  if (scenario.saturdayEveningFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 6 && localHour >= 18 && localHour < 20;
}

/** Sunday 18:00-20:00 keeps weekday FX depth when Sunday evening FX open is on. Distinct from saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayEveningFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayEveningFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 18 && localHour < 20;
}

/** Sunday 20:00-22:00 keeps weekday FX depth when Sunday night FX open is on. Distinct from saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayEveningFxOpen (Sun 18:00-20:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayNightFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayNightFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 20 && localHour < 22;
}

/** Sunday 22:00-24:00 keeps weekday FX depth when Sunday late-night FX open is on. Distinct from saturdayNightFxOpen (Sat 20:00-22:00), sundayNightFxOpen (Sun 20:00-22:00), sundayEveningFxOpen (Sun 18:00-20:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayLateNightFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayLateNightFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
...
/** Saturday 22:00-24:00 keeps weekday FX depth when Saturday late-night FX open is on. Distinct from sundayLunchFxOpen (Sun 10:00-12:00), sundayBrunchFxOpen (Sun 09:00-11:00), sundayBreakfastFxOpen (Sun 07:00-09:00), sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
...
/** Sunday 00:00-02:00 keeps weekday FX depth when Sunday predawn FX open is on. Distinct from sundayLunchFxOpen (Sun 10:00-12:00), sundayBrunchFxOpen (Sun 09:00-11:00), sundayBreakfastFxOpen (Sun 07:00-09:00), sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayPredawnFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayPredawnFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 0 && localHour < 2;
}

/** Sunday 02:00-04:00 keeps weekday FX depth when Sunday dawn FX open is on. Distinct from sundayLunchFxOpen (Sun 10:00-12:00), sundayBrunchFxOpen (Sun 09:00-11:00), sundayBreakfastFxOpen (Sun 07:00-09:00), sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayDawnFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayDawnFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 2 && localHour < 4;
}

/** Sunday 04:00-06:00 keeps weekday FX depth when Sunday daybreak FX open is on. Distinct from sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayDaybreakFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayDaybreakFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 4 && localHour < 6;
}

/** Sunday 06:00-08:00 keeps weekday FX depth when Sunday sunrise FX open is on. Distinct from sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundaySunriseFxOpenHour(hourOffset, scenario) {
  if (scenario.sundaySunriseFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 6 && localHour < 8;
}

/** Sunday 07:00-09:00 keeps weekday FX depth when Sunday breakfast FX open is on. Distinct from sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayBreakfastFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayBreakfastFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 7 && localHour < 9;
}

/** Sunday 09:00-11:00 keeps weekday FX depth when Sunday brunch FX open is on. Distinct from sundayLunchFxOpen (Sun 10:00-12:00), sundayBreakfastFxOpen (Sun 07:00-09:00), sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayBrunchFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayBrunchFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 9 && localHour < 11;
}

/** Sunday 10:00-12:00 keeps weekday FX depth when Sunday lunch FX open is on. Distinct from sundayBrunchFxOpen (Sun 09:00-11:00), sundayBreakfastFxOpen (Sun 07:00-09:00), sundaySunriseFxOpen (Sun 06:00-08:00), sundayDaybreakFxOpen (Sun 04:00-06:00), sundayDawnFxOpen (Sun 02:00-04:00), sundayPredawnFxOpen (Sun 00:00-02:00), saturdayLateNightFxOpen (Sat 22:00-24:00), saturdayNightFxOpen (Sat 20:00-22:00), sundayLateNightFxOpen (Sun 22:00-24:00), sundayNightFxOpen (Sun 20:00-22:00), saturdayEveningFxOpen (Sat 18:00-20:00), sundayEveningFxOpen (Sun 18:00-20:00), sundayLateFxOpen (Sun 16:00-18:00), sundayAfternoonFxOpen (Sun 14:00-16:00), sundayMiddayFxOpen (Sun 12:00-14:00), sundayMorningFxOpen (Sun 10:00-12:00), sundayEarlyFxOpen (Sun 08:00-10:00), saturdayLateFxOpen, saturdayAfternoonFxOpen, saturdayMiddayFxOpen, saturdayEarlyFxOpen, fridayEarlyFxOpen, fridayLateFxOpen, and saturdayLatePayoutOpen. */
function isSundayLunchFxOpenHour(hourOffset, scenario) {
  if (scenario.sundayLunchFxOpen !== true) return false;
  const { dayIndex, localHour } = dayAndHourAt(hourOffset);
  return dayIndex === 0 && localHour >= 10 && localHour < 12;
}
...
export function getOperationalStatus(scenarioInput, hourOffset) {
  ...
  return {
    ...
    weekend,
    fxWeekday,
    fxDepthAudPerHour: scheduledThroughput.fx ?? scenario.fxDepthAudPerHour / fxMultiplier,
...
export function buildDemandSchedule(totalDemandAud, hours = SIMULATION_HOURS, profile = "flat") {
  ...
  if (!["flat", "fridayBurst", "mondayRush", "saturdayBurst", "sundayBurst"].includes(profile)) throw new RangeError("Unknown demand profile.");
...
export function capacityForHour(scenarioInput, hourOffset, reserveRemainingAud) {
  ...
  const throughput = throughputAtHour(scenario, hourOffset);
  ...
  const limits = [
    [throughput.issuer, "issuer throughput"],
    [status.fxDepthAudPerHour, "FX depth"],
    [throughput.payout, "payout throughput"],
...
export function planReserve(input, targetPercent = 100, deadlineHour = null) {
  ...
  const hours = scenarioHours(scenario);
  if (deadlineHour === null) deadlineHour = hours;
  if (!Number.isInteger(deadlineHour) || deadlineHour < 1 || deadlineHour > hours) {
    throw new RangeError(`Deadline must be a whole hour from 1 to ${hours}.`);
  }
...
export function analysisToJSON(baselineInput, candidateInput, targetPercent = 100, deadlineHour = null) {
  ...
  return JSON.stringify({ format: ANALYSIS_FORMAT, version: 1,
    ...
    timeline: comparison.candidate.timeline.map((point, index) => ({
      hour: point.hour, time: point.timeLabel, baselineQueuedAud: index < comparison.baseline.timeline.length ? comparison.baseline.timeline[index].queuedAud : null,
...
export function analyzeTimeline(input) {
  ...
  let currentRun = 0;
  const timelineHours = scenarioHours(result.scenario);
  for (let hour = 0; hour < timelineHours; hour += 1) {
...
const LEGACY_HIDE_GANTT_KEYS = Object.freeze([
  "hideWeekdayGanttHours",
  "hideWeekendGanttHours",
  "hideOpenGanttHours",
  "hideClosedGanttHours",
  "hideZeroQueueGanttHours",
  "hideBankClosedGanttHours",
  "hideIssuerClosedGanttHours",
  "hidePayoutClosedGanttHours",
  "hideFxClosedGanttHours",
  "hidePayoutOpenGanttHours",
  "hideFxOpenGanttHours",
  "hideBankOpenGanttHours",
  "hideIssuerOpenGanttHours",
  "hideWeekendIssuerOpenGanttHours",
  "hideWeekendIssuerClosedGanttHours",
  "hideWeekendBankClosedGanttHours",
  "hideWeekendBankOpenGanttHours",
...
const WORKSPACE_KEYS = Object.freeze([
  ...
  "ganttHourFilter",
  ...LEGACY_HIDE_GANTT_KEYS
]);

/** Map legacy per-gate hide flags to the consolidated hour filter. The first matching
 * legacy filter wins so old workspaces still show roughly what they saved. */
export function legacyHourFilterFromKeys(raw) {
  if (raw?.hideWeekdayGanttHours === true) return "weekend";
  if (raw?.hideWeekendGanttHours === true) return "weekday";
  if (raw?.hideOpenGanttHours === true) return "any-closed";
  if (raw?.hideClosedGanttHours === true) return "any-open";
  if (raw?.ganttClosedOnly === true) return "any-closed";
  if (raw?.ganttEveryGateClosed === true) return "every-closed";
  if (raw?.hideZeroQueueGanttHours === true) return "queued";
  for (const gate of ["bank", "issuer", "payout", "fx"]) {
    if (raw?.[`hide${gate.charAt(0).toUpperCase()}${gate.slice(1)}ClosedGanttHours`] === true) return "any-closed";
  }
  return "all";
}
...
export function workspaceToJSON(current, baseline, options = {}) {
  const { targetPercent = 100, deadlineHour = 72, selectedHour = 0, notes = "", ganttDensity = "snapshots", selectedChart = "queue", ganttClosedOnly = false, ganttGateFilter = "all", queueBacklogOnly = false, ganttEveryGateClosed = false, ganttHourFilter = "all" } = options;
  const ganttHourIndex = options.ganttHourIndex === undefined ? selectedHour : options.ganttHourIndex;
  const horizon = scenarioHours(sanitizeScenario(current).scenario);
  if (!Number.isFinite(targetPercent) || targetPercent < 0 || targetPercent > 100 || !Number.isInteger(deadlineHour) || deadlineHour < 1 || deadlineHour > horizon || !Number.isInteger(selectedHour) || selectedHour < 0 || selectedHour > horizon) throw new RangeError("Workspace target, deadline or selected hour is invalid.");
  if (!Number.isInteger(ganttHourIndex) || ganttHourIndex < 0 || ganttHourIndex > horizon) throw new RangeError("Workspace Gantt hour index is invalid.");
  ...
  if (!GANTT_HOUR_FILTERS.includes(ganttHourFilter)) throw new RangeError("Workspace Gantt hour filter is invalid.");
  return JSON.stringify({ format: "weekend-gap-workspace", version: 1, current: sanitizeScenario(current).scenario,
    baseline: sanitizeScenario(baseline).scenario, targetPercent, deadlineHour, selectedHour, notes, ganttDensity, selectedChart, ganttClosedOnly, ganttGateFilter, queueBacklogOnly, ganttHourIndex, ganttEveryGateClosed, ganttHourFilter }, null, 2);
}
export function workspaceFromJSON(text) {
  try {
    ...
    const options = {
      ...
      ganttHourFilter: raw.ganttHourFilter === undefined ? legacyHourFilterFromKeys(raw) : raw.ganttHourFilter
    };
...
export function timelineToCSV(current, baseline = current) {
  ...
  const rows = comparison.candidate.timeline.map((point, index) => [point.hour, point.timeLabel, point.hour === 0 ? "" : point.hour - 1,
    point.demandThisHour, point.settledThisHour, point.settledAud, point.queuedAud, point.reserveRemainingAud, point.immediateAud, index < comparison.baseline.timeline.length ? comparison.baseline.timeline[index].queuedAud : ""]);
...
export function queueToCSV(current, baseline = current) {
  ...
  const rows = comparison.candidate.timeline.map((point, index) => [
    ...
    point.timeLabel,
    point.queuedAud,
    index < comparison.baseline.timeline.length ? comparison.baseline.timeline[index].queuedAud : "",
...
export function reportToHTML(current, baseline, options = {}) {
  ...
  const queueClearText = (hours, peak) => hours === null ? (peak > 0 ? "queue remains" : `No queue in ${horizon}h`) : hours + " hour" + (hours === 1 ? "" : "s");
...
export function hoursToClearQueueToMarkdown(input) {
  const result = runSimulation(input);
  const label = hoursToClearLabel(result.summary.hoursToClearQueue, result.summary.peakQueuedAud, scenarioHours(result.scenario));
...
export function hoursToFirstSettlementToMarkdown(input) {
  const result = runSimulation(input);
  const label = hoursToFirstSettlementLabel(result.summary.hoursToFirstSettlement, scenarioHours(result.scenario));
...
export function bottleneckCountsToMarkdown(input) {
  ...
  return [
    ...
    "",
    `Observation counts of the ${attribution.hours} interval-start limitingGate values. Not a causal ranking.`,
    "",
    "| Limiter | Hours | Share of " + attribution.hours + "h |",
    "| --- | --- | --- |",
    ...rows,
    "",
...
export function stepDemandProfile(profile, direction) {
  ...
  if (profile === "sundayBurst") return direction === "earlier" ? "saturdayBurst" : "mondayRush";
...
export function buildGateSchedule(input) {
  const { scenario } = sanitizeScenario(input);
  const horizon = scenarioHours(scenario);
  const hours = [];
...
export function firstClosedGanttHour(input) {
  ...
  const chartHours = schedule.hours.filter((point) => point.hour < schedule.hours.length - 1);
...
export function firstClosedFxGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && !point.fxWeekday);
  return closed ? closed.hour : null;
}

/** First chart hour where the issuer gate is closed. Honest empty when none of the 72 hours is closed. */
export function firstClosedIssuerGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && !point.issuerOpen);
  return closed ? closed.hour : null;
}

/** First chart hour where the payout gate is closed. Honest empty when none of the 72 hours is closed. */
export function firstClosedPayoutGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && !point.payoutOpen);
  return closed ? closed.hour : null;
}

/** First chart hour where the payout gate is open. Honest empty when none of the 72 hours is open. */
export function firstOpenPayoutGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && point.payoutOpen);
  return open ? open.hour : null;
}

/** First chart hour where FX is weekday depth. Honest empty when none of the 72 hours is open. */
export function firstOpenFxGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && point.fxWeekday);
  return open ? open.hour : null;
}

/** First chart hour where the bank gate is open. Honest empty when none of the 72 hours is open. */
export function firstOpenBankGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && point.bankOpen);
  return open ? open.hour : null;
}

/** First chart hour where the issuer gate is open. Honest empty when none of the 72 hours is open. */
export function firstOpenIssuerGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && point.issuerOpen);
  return open ? open.hour : null;
}
...
export function lastOpenIssuerGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && point.issuerOpen);
  return open ? open.hour : null;
}

/** Last chart hour where the bank gate is open. Honest empty when none of the 72 hours is open. */
export function lastOpenBankGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && point.bankOpen);
  return open ? open.hour : null;
}

/** Last chart hour where the payout gate is open. Honest empty when none of the 72 hours is open. Distinct from last-open-bank and first-open-payout. */
export function lastOpenPayoutGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && point.payoutOpen);
  return open ? open.hour : null;
}

/** Last chart hour where FX is weekday depth. Honest empty when none of the 72 hours is open. Distinct from last-open-bank, last-open-payout and first-open-FX. */
export function lastOpenFxGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && point.fxWeekday);
  return open ? open.hour : null;
}

/** Last chart hour where the issuer gate is closed. Honest empty when none of the 72 hours is closed. */
export function lastClosedIssuerGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && !point.issuerOpen);
  return closed ? closed.hour : null;
}

/** Last chart hour where the bank gate is closed. Honest empty when none of the 72 hours is closed. */
export function lastClosedBankGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && !point.bankOpen);
  return closed ? closed.hour : null;
}

/** Last chart hour where FX is weekend-thinned. Honest empty when none of the 72 hours is closed. Distinct from last-open-FX, last-open-payout and first-closed-FX. */
export function lastClosedFxGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && !point.fxWeekday);
  return closed ? closed.hour : null;
}

/** Last chart hour where the payout gate is closed. Honest empty when none of the 72 hours is closed. Distinct from last-closed-FX, last-closed-bank, last-closed-issuer and last-open-payout. */
export function lastClosedPayoutGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && !point.payoutOpen);
  return closed ? closed.hour : null;
}
...
export function lastWeekendFxClosedGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekendFxClosed(point));
  return closed ? closed.hour : null;
}

/** Last chart hour that is weekday and FX-closed. Honest empty when none of the 72 hours matches. Distinct from last-weekend-FX-closed, last-closed-FX and last-closed-payout. */
export function lastWeekdayFxClosedGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekdayFxClosed(point));
  return closed ? closed.hour : null;
}

/** Last chart hour that is weekend and FX-open. Honest empty when none of the 72 hours matches. Distinct from last-weekday-FX-closed, last-weekend-FX-closed and last-closed-FX. */
export function lastWeekendFxOpenGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekendFxOpen(point));
  return open ? open.hour : null;
}

/** Last chart hour that is weekday and FX-open. Honest empty when none of the 72 hours matches. Distinct from last-weekend-FX-open, last-weekday-FX-closed and last-weekend-FX-closed. */
export function lastWeekdayFxOpenGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.findLast((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekdayFxOpen(point));
  return open ? open.hour : null;
}

/** First chart hour that is weekday and FX-open. Honest empty when none of the 72 hours matches. Distinct from last-weekday-FX-open, last-weekend-FX-open and last-weekday-FX-closed. */
export function firstWeekdayFxOpenGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekdayFxOpen(point));
  return open ? open.hour : null;
}

/** First chart hour that is weekday and FX-closed. Honest empty when none of the 72 hours matches. Distinct from last-weekday-FX-closed, first-weekday-FX-open, last-weekday-FX-open and last-weekend-FX-closed. */
export function firstWeekdayFxClosedGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekdayFxClosed(point));
  return closed ? closed.hour : null;
}

/** First chart hour that is weekend and FX-open. Honest empty when none of the 72 hours matches. Distinct from first-weekday-FX-closed, first-weekday-FX-open, last-weekday-FX-open, last-weekend-FX-open, last-weekday-FX-closed, last-weekend-FX-closed and last-closed-FX. */
export function firstWeekendFxOpenGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const open = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekendFxOpen(point));
  return open ? open.hour : null;
}
...
export function firstWeekendFxClosedGanttHour(input) {
  const schedule = buildGateSchedule(input);
  const closed = schedule.hours.find((point) => point.hour < schedule.hours.length - 1 && ganttHourWeekendFxClosed(point));
  return closed ? closed.hour : null;
}
...
export function ganttHourIsWeekend(point) {
  ...
  const { dayIndex } = dayAndHourAt(point.hour);
  return dayIndex === 0 || dayIndex === 6;
}

/** True when the synthetic queue at this hour is zero. Display filter only. */
export function ganttHourHasZeroQueue(point) {
  if (!point || typeof point !== "object") return false;
  return !(point.queuedAud > 0);
}

/** True when the bank gate is closed. Display filter only. Distinct from every-gate-closed. */
export function ganttHourBankClosed(point) {
  if (!point || typeof point !== "object") return false;
  return point.bankOpen === false;
}

/** True when the issuer gate is closed. Display filter only. Distinct from bank-closed. */
export function ganttHourIssuerClosed(point) {
  if (!point || typeof point !== "object") return false;
  return point.issuerOpen === false;
}

/** True when the payout gate is closed. Display filter only. Distinct from issuer-closed and bank-closed. */
export function ganttHourPayoutClosed(point) {
  if (!point || typeof point !== "object") return false;
  return point.payoutOpen === false;
}

/** True when FX is weekend-thinned. Display filter only. Distinct from payout-closed. */
export function ganttHourFxClosed(point) {
  if (!point || typeof point !== "object") return false;
  return point.fxWeekday === false;
}

/** True when the payout gate is open. Display filter only. Distinct from payout-closed and every-gate-open. */
export function ganttHourPayoutOpen(point) {
  if (!point || typeof point !== "object") return false;
  return point.payoutOpen === true;
}

/** True when FX is weekday depth. Display filter only. Distinct from FX-closed and payout-open. */
export function ganttHourFxOpen(point) {
  if (!point || typeof point !== "object") return false;
  return point.fxWeekday === true;
}

/** True when the bank gate is open. Display filter only. Distinct from bank-closed and FX-open. */
export function ganttHourBankOpen(point) {
  if (!point || typeof point !== "object") return false;
...
/** True when the hour is a weekend hour and the issuer gate is open. Display filter only. */
export function ganttHourWeekendIssuerOpen(point) {
  return ganttHourIsWeekend(point) && ganttHourIssuerOpen(point);
}

/** True when the hour is a weekend hour and the issuer gate is closed. Display filter only. */
export function ganttHourWeekendIssuerClosed(point) {
  return ganttHourIsWeekend(point) && ganttHourIssuerClosed(point);
}

/** True when the hour is a weekend hour and the bank gate is closed. Display filter only. */
export function ganttHourWeekendBankClosed(point) {
  return ganttHourIsWeekend(point) && ganttHourBankClosed(point);
}

/** True when the hour is a weekend hour and the bank gate is open. Display filter only. Distinct from weekend-bank-closed and weekend-issuer-open. */
export function ganttHourWeekendBankOpen(point) {
  return ganttHourIsWeekend(point) && ganttHourBankOpen(point);
}

/** True when the hour is a weekend hour and the payout gate is open. Display filter only. Distinct from weekend-bank-open, payout-open and weekend-issuer-open. */
export function ganttHourWeekendPayoutOpen(point) {
  return ganttHourIsWeekend(point) && ganttHourPayoutOpen(point);
}

/** True when the hour is a weekend hour and FX is weekday-depth / open. Display filter only. Distinct from weekend-payout-open, FX-open and weekend-bank-open. */
export function ganttHourWeekendFxOpen(point) {
  return ganttHourIsWeekend(point) && ganttHourFxOpen(point);
}

/** True when the hour is a weekday hour and FX is weekday-depth / open. Display filter only. Complementary to weekend-FX-open. Distinct from FX-open and weekday-FX-closed. */
export function ganttHourWeekdayFxOpen(point) {
  return !ganttHourIsWeekend(point) && ganttHourFxOpen(point);
}

/** True when the hour is a weekend hour and the payout gate is closed. Display filter only. Distinct from weekend-FX-open, weekend-payout-open and payout-closed. */
export function ganttHourWeekendPayoutClosed(point) {
  return ganttHourIsWeekend(point) && ganttHourPayoutClosed(point);
}

/** True when the hour is a weekend hour and FX is weekend-thinned / closed. Display filter only. Distinct from FX-closed, weekend-FX-open and weekend-payout-closed. */
export function ganttHourWeekendFxClosed(point) {
...
/** Consolidated Gantt hour-filter values. Replaces the earlier per-gate hide checkboxes. */
export const GANTT_HOUR_FILTERS = Object.freeze([
  "all",
  "any-closed",
  "every-closed",
  "any-open",
...
/**
 * True when a schedule hour passes the consolidated Gantt hour filter.
 * "any-closed" keeps hours closed on at least one gate; "any-open" keeps hours
 * open on at least one gate (FX weekend thinning counts as closed); "queued"
 * keeps hours whose synthetic queue is nonzero. selectedHour always passes.
 */
export function ganttHourMatchesFilter(point, hourFilter = "all", queuePoint = null, selectedHour = null) {
  if (!point || typeof point !== "object") return false;
  if (selectedHour !== null && point.hour === selectedHour) return true;
  switch (hourFilter) {
    case "any-closed":
      return ganttHourClosedOnAnyGate(point);
    case "every-closed":
      return ganttHourClosedOnEveryGate(point);
    case "any-open":
      return !ganttHourClosedOnEveryGate(point);
    case "weekend":
      return ganttHourIsWeekend(point);
    case "weekday":
      return !ganttHourIsWeekend(point);
    case "queued":
      return !(queuePoint ? ganttHourHasZeroQueue(queuePoint) : false);
    default:
      return true;
  }
}

/** One-line first/last open or closed hour label for one gate. Honest empty when none exists. */
export function gateHourToMarkdown(input, gate, boundary = "first", open = true) {
  const gateKey = `${gate}Open`;
  const schedule = buildGateSchedule(input);
  const matches = (point) => point.hour < schedule.hours.length - 1
    && (gate === "fx" ? (open ? point.fxWeekday : !point.fxWeekday) : (open ? point[gateKey] === true : point[gateKey] === false));
  const point = boundary === "last"
    ? schedule.hours.findLast(matches)
    : schedule.hours.find(matches);
  const gateName = gate === "fx" ? "FX" : gate.charAt(0).toUpperCase() + gate.slice(1);
  const state = open ? "open" : "closed";
  if (!point) {
    return `${gateName} ${state} hours: none in the 72-hour window. Counts of modeled hours, not a bank calendar.`;
  }
  const boundaryLabel = boundary === "last" ? "Last" : "First";
  return `${boundaryLabel} ${state} ${gateName} hour: ${formatTime(point.hour)} (hour ${point.hour}). Counts of modeled hours, not a bank calendar.`;
}

/** Multi-line hour evidence for one gate: first and last open and closed hours plus gate hour counts. */
export function gateHourEvidenceToMarkdown(input, gate) {
  return [
    `# Weekend Gap ${gate === "fx" ? "FX" : gate} hours`,
    "",
    gateHourToMarkdown(input, gate, "first", true),
    gateHourToMarkdown(input, gate, "last", true),
    gateHourToMarkdown(input, gate, "first", false),
    gateHourToMarkdown(input, gate, "last", false),
    gateHourCountsToMarkdown(input, gate)
  ].join("\n");
}

/** Counts of open and closed modeled hours for one gate. Not a bank calendar. */
export function gateHourCountsToMarkdown(input, gate) {
  const schedule = buildGateSchedule(input);
  const hours = schedule.hours.length - 1;
  let open = 0;
  for (let hour = 0; hour < hours; hour += 1) {
    const point = schedule.hours[hour];
    const isOpen = gate === "fx" ? point.fxWeekday : point[`${gate}Open`] === true;
    if (isOpen) open += 1;
  }
  const gateName = gate === "fx" ? "FX" : gate.charAt(0).toUpperCase() + gate.slice(1);
  return `${gateName} hours: ${open} open, ${hours - open} closed out of ${hours}. Counts of modeled hours, not a bank calendar.`;
}

/** Light, print-friendly SVG of 72 operating hours plus a selected-hour marker. */
/** Tick hours for time SVGs: hour 0, every local midnight, and the final hour. */
export function svgTickHours(hours) {
  const ticks = [0];
  for (let hour = 1; hour < hours; hour += 1) {
    if (dayAndHourAt(hour).localHour === 0) ticks.push(hour);
  }
...
export function buildGateGanttSvg(input, selectedHour = 0, options = {}) {
  const schedule = buildGateSchedule(input);
  const hours = schedule.hours.length - 1;
  const markerHour = clamp(Math.round(finiteNumber(selectedHour, 0)), 0, hours);
  const hourFilter = GANTT_HOUR_FILTERS.includes(options.hourFilter) ? options.hourFilter : "all";
  ...
  const hourWidth = plotWidth / hours;
  const firstPayout = nextPayoutTime(schedule.scenario, 0);
  const queueTimeline = hourFilter === "queued" ? runSimulation(input).timeline : null;
  const visibleHours = new Set([markerHour]);
  for (let hour = 0; hour < hours; hour += 1) {
    if (ganttHourMatchesFilter(schedule.hours[hour], hourFilter, queueTimeline ? queueTimeline[hour] : null, markerHour)) {
  ...
  const markerX = labelWidth + (markerHour / hours) * plotWidth;
  const labels = rows.map((row, index) => `<text x="8" y="${top + index * rowHeight + 18}" font-size="12" fill="#17324a">${svgEscape(row[1])}</text>`).join("");
  const ticks = svgTickHours(hours).map((hour) => {
    const x = labelWidth + (hour / hours) * plotWidth;
  ...
  const payoutX = firstPayout === null || firstPayout > hours ? null : labelWidth + (firstPayout / hours) * plotWidth;
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${width} ${height}" width="100%" role="img" aria-label="${hours}-hour gate Gantt for issuer, bank, payout and FX. Solid fill is open or weekday depth. Hatched fill is closed or weekend thinning. Current hour is the solid vertical marker. First payout window is the dashed marker. A table follows.">` +
...
/** Gate open/closed for the modeled hours drawn on the Gantt chart. */
export function ganttToCSV(input) {
  const schedule = buildGateSchedule(input);
  const headers = ["hour", "time_label", "issuer", "bank", "payout", "fx"];
  const rows = [];
  for (let hour = 0; hour < schedule.hours.length - 1; hour += 1) {
    const point = schedule.hours[hour];
    rows.push([
      point.hour,
      point.timeLabel,
...
export function selectedGanttHourToMarkdown(input, selectedHour = 0) {
  const schedule = buildGateSchedule(input);
  const hour = clamp(Math.round(finiteNumber(selectedHour, 0)), 0, schedule.hours.length - 1);
  const point = schedule.hours[hour];
  return [
...
export function remainingReserveAtHourToMarkdown(input, selectedHour = 0) {
  const result = runSimulation(input);
  const hour = clamp(Math.round(finiteNumber(selectedHour, 0)), 0, result.timeline.length - 1);
...
/** One-line first closed issuer hour label. Honest empty when none exists. Distinct from first-closed-FX and first-closed-bank copy. */
export function firstClosedIssuerHourToMarkdown(input) {
  const hour = firstClosedIssuerGanttHour(input);
  if (hour === null) {
    return "First closed issuer hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "First closed issuer hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line first closed payout hour label. Honest empty when none exists. Distinct from first-closed-FX, first-closed-bank and first-closed-issuer copy. */
export function firstClosedPayoutHourToMarkdown(input) {
  const hour = firstClosedPayoutGanttHour(input);
  if (hour === null) {
    return "First closed payout hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "First closed payout hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line first open payout hour label. Honest empty when none exists. Distinct from first-closed-payout copy. */
export function firstOpenPayoutHourToMarkdown(input) {
  const hour = firstOpenPayoutGanttHour(input);
  if (hour === null) {
    return "First open payout hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "First open payout hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line first open FX hour label. Honest empty when none exists. Distinct from first-open-payout and first-closed-FX copy. */
export function firstOpenFxHourToMarkdown(input) {
  const hour = firstOpenFxGanttHour(input);
  if (hour === null) {
    return "First open FX hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "First open FX hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line first open bank hour label. Honest empty when none exists. Distinct from first-open-FX copy. */
export function firstOpenBankHourToMarkdown(input) {
  const hour = firstOpenBankGanttHour(input);
  if (hour === null) {
    return "First open bank hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "First open bank hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line first open issuer hour label. Honest empty when none exists. Distinct from first-open-bank and first-closed-issuer copy. */
export function firstOpenIssuerHourToMarkdown(input) {
  const hour = firstOpenIssuerGanttHour(input);
  if (hour === null) {
...
/** One-line last open bank hour label. Honest empty when none exists. Distinct from last-closed-bank copy and last-open-issuer copy. */
export function lastOpenBankHourToMarkdown(input) {
  const hour = lastOpenBankGanttHour(input);
  if (hour === null) {
    return "Last open bank hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "Last open bank hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line last open payout hour label. Honest empty when none exists. Distinct from last-open-bank, last-open-issuer and first-open-payout copy. */
export function lastOpenPayoutHourToMarkdown(input) {
  const hour = lastOpenPayoutGanttHour(input);
  if (hour === null) {
    return "Last open payout hour: none. Counts of modeled hours, not a payout calendar.";
  }
  return "Last open payout hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a payout calendar.";
}

/** One-line last open FX hour label. Honest empty when none exists. Distinct from last-open-bank, last-open-payout and first-open-FX copy. */
export function lastOpenFxHourToMarkdown(input) {
  const hour = lastOpenFxGanttHour(input);
  if (hour === null) {
    return "Last open FX hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "Last open FX hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line last closed issuer hour label. Honest empty when none exists. Distinct from last-open-issuer and first-closed-issuer copy. */
export function lastClosedIssuerHourToMarkdown(input) {
  const hour = lastClosedIssuerGanttHour(input);
  if (hour === null) {
    return "Last closed issuer hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "Last closed issuer hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line last closed bank hour label. Honest empty when none exists. Distinct from last-closed-issuer copy. */
export function lastClosedBankHourToMarkdown(input) {
  const hour = lastClosedBankGanttHour(input);
  if (hour === null) {
    return "Last closed bank hour: none. Counts of modeled hours, not a bank calendar.";
  }
  return "Last closed bank hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not a bank calendar.";
}

/** One-line last closed FX hour label. Honest empty when none exists. Distinct from last-open-FX, last-open-payout and first-closed-FX copy. */
export function lastClosedFxHourToMarkdown(input) {
  const hour = lastClosedFxGanttHour(input);
  if (hour === null) {
    return "Last closed FX hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "Last closed FX hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line last closed payout hour label. Honest empty when none exists. Distinct from last-closed-FX, last-closed-bank, last-closed-issuer and last-open-payout copy. */
export function lastClosedPayoutHourToMarkdown(input) {
  const hour = lastClosedPayoutGanttHour(input);
  if (hour === null) {
...
/** One-line last weekday-FX-closed hour label. Honest empty when none exists. Distinct from last-weekend-FX-closed, last-closed-FX and last-closed-payout copy. */
export function lastWeekdayFxClosedHourToMarkdown(input) {
  const hour = lastWeekdayFxClosedGanttHour(input);
  if (hour === null) {
    return "Last weekday-FX-closed hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "Last weekday-FX-closed hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line last weekend-FX-open hour label. Honest empty when none exists. Distinct from last-weekday-FX-closed, last-weekend-FX-closed and last-closed-FX copy. */
export function lastWeekendFxOpenHourToMarkdown(input) {
  const hour = lastWeekendFxOpenGanttHour(input);
  if (hour === null) {
    return "Last weekend-FX-open hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "Last weekend-FX-open hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line last weekday-FX-open hour label. Honest empty when none exists. Distinct from last-weekend-FX-open, last-weekday-FX-closed and last-weekend-FX-closed copy. */
export function lastWeekdayFxOpenHourToMarkdown(input) {
  const hour = lastWeekdayFxOpenGanttHour(input);
  if (hour === null) {
    return "Last weekday-FX-open hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "Last weekday-FX-open hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line first weekday-FX-open hour label. Honest empty when none exists. Distinct from last-weekday-FX-open, last-weekend-FX-open and last-weekday-FX-closed copy. */
export function firstWeekdayFxOpenHourToMarkdown(input) {
  const hour = firstWeekdayFxOpenGanttHour(input);
  if (hour === null) {
    return "First weekday-FX-open hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "First weekday-FX-open hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line first weekday-FX-closed hour label. Honest empty when none exists. Distinct from last-weekday-FX-closed, first-weekday-FX-open, last-weekday-FX-open and last-weekend-FX-closed copy. */
export function firstWeekdayFxClosedHourToMarkdown(input) {
  const hour = firstWeekdayFxClosedGanttHour(input);
  if (hour === null) {
    return "First weekday-FX-closed hour: none. Counts of modeled hours, not an FX calendar.";
  }
  return "First weekday-FX-closed hour: " + formatTime(hour) + " (hour " + hour + "). Counts of modeled hours, not an FX calendar.";
}

/** One-line first weekend-FX-open hour label. Honest empty when none exists. Distinct from first-weekday-FX-closed, first-weekday-FX-open, last-weekday-FX-open, last-weekend-FX-open, last-weekday-FX-closed, last-weekend-FX-closed and last-closed-FX copy. */
export function firstWeekendFxOpenHourToMarkdown(input) {
  const hour = firstWeekendFxOpenGanttHour(input);
  if (hour === null) {
...
/** Markdown for arrival-hour cohorts. Remaining is unfinished after the horizon. Not a forecast. */
export function arrivalCohortsToMarkdown(input) {
  const result = runSimulation(input);
  const cohorts = [];
  let front = 0;
  for (let hour = 0; hour < result.timeline.length - 1; hour += 1) {
...
export function compareGateSchedules(baselineInput, currentInput) {
  ...
  const span = Math.max(baseline.hours.length, current.hours.length) - 1;
  const hours = [];
  for (let hour = 0; hour <= span; hour += 1) {
    const before = hour < baseline.hours.length ? baseline.hours[hour] : null;
    const after = hour < current.hours.length ? current.hours[hour] : null;
    const differs = !before || !after || before.issuerOpen !== after.issuerOpen
      || before.bankOpen !== after.bankOpen
      || before.payoutOpen !== after.payoutOpen
      || before.fxWeekday !== after.fxWeekday;
    const side = (point) => point === null ? null : Object.freeze({
      issuerOpen: point.issuerOpen,
      bankOpen: point.bankOpen,
      payoutOpen: point.payoutOpen,
      fxWeekday: point.fxWeekday
    });
    hours.push(Object.freeze({
      hour,
      timeLabel: (after ?? before).timeLabel,
      differs,
      current: side(after),
...
export function buildComparisonGanttSvg(baselineInput, currentInput, selectedHour = 0) {
  ...
  const hours = Math.max(currentSchedule.hours.length, baselineSchedule.hours.length) - 1;
  const markerHour = clamp(Math.round(finiteNumber(selectedHour, 0)), 0, hours);
  const width = 720;
  const rowHeight = 24;
  ...
  let cells = "";
  const span = Math.max(currentSchedule.hours.length, baselineSchedule.hours.length) - 1;
  const labels = pairs.map((row, rowIndex) => {
    const y = top + rowIndex * rowHeight;
    for (let hour = 0; hour < span; hour += 1) {
      if (hour >= row[1].hours.length - 1) continue;
  ...
  const markerX = labelWidth + (markerHour / span) * plotWidth;
  const ticks = svgTickHours(span).map((hour) => {
    const x = labelWidth + (hour / span) * plotWidth;
    return `<text x="${x.toFixed(1)}" y="${height - 8}" font-size="10" text-anchor="middle" fill="#3e5360">${svgEscape(formatTime(hour))}</text>`;
  }).join("");
...
export function buildQueueChartSvg(currentInput, baselineInput = currentInput, selectedHour = 0) {
  ...
  const span = Math.max(current.length, baseline.length) - 1;
  const markerHour = clamp(Math.round(finiteNumber(selectedHour, 0)), 0, span);
  const xAt = (hour) => left + (hour / span) * plotWidth;
