...
test("keyboard Shift+F10 is wired to copy last weekend-FX-closed hour before unshifted F10", async () => {
  ...
  assert.notEqual(app.match(/function copyLastWeekendFxClosedHourMarkdown/)?.[0], app.match(/function copyFirstWeekendFxClosedHourMarkdown/)?.[0]);
  assert.notEqual(app.match(/function copyLastWeekendFxClosedHourMarkdown/)?.[0], app.match(/function copyFirstWeekendFxOpenHourMarkdown/)?.[0]);
  assert.notEqual(app.match(/function copyLastWeekendFxClosedHourMarkdown/)?.[0], app.match(/function copyLastWeekdayFxClosedHourMarkdown/)?.[0]);
