...
test("1.5.29 keeps last-weekday-FX-open copy control without taking unshifted F10", async () => {
  ...
  assert.match(app, /copyFirstWeekdayFxOpenHourMarkdown\(\)/);
  ...
  assert.notEqual(app.match(/function copyLastWeekdayFxOpenHourMarkdown/)?.[0], app.match(/function copyFirstWeekdayFxOpenHourMarkdown/)?.[0]);
