...
async function boot(storage = new Map(), { blockedStorage = false, hash = "" } = {}) {
  const nodes = new Map();
  ...
  const window = { location, devicePixelRatio: 1, addEventListener() {}, setInterval() { return 1; }, clearInterval() {}, setTimeout() {}, matchMedia() { return { matches: false, addEventListener() {} }; } };
