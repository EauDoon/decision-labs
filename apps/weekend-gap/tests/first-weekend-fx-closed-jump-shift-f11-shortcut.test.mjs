...
test("keyboard Shift+F11 is wired to the first-weekend-FX-closed-hour copy control before unshifted F11", async () => {
  ...
  assert.notEqual(app.match(/function jumpToFirstWeekendFxClosedCopy/)?.[0], app.match(/function jumpToFirstWeekendFxOpenCopy/)?.[0]);
  ...
  const shiftFn = app.slice(app.indexOf("function jumpToFirstWeekendFxClosedCopy"), app.indexOf("function jumpToHideWeekdayFxOpenFilter"));
