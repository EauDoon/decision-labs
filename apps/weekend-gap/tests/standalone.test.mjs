...
test("release 1.5.36 ships Friday early FX open, first-weekend-FX-closed copy and weekday-FX-closed hide jump", async () => {
  ...
  assert.match(html.slice(shiftF10, shiftF10 + 180), /copyFirstWeekendFxClosedHourMarkdown\(\)/);
  assert.match(html.slice(shiftF11, shiftF11 + 180), /jumpToFirstWeekendFxClosedCopy\(\)/);
