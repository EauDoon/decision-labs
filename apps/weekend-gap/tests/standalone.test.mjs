...
test("release 1.5.37 ships Saturday midday FX open, last-weekday-FX-open copy and weekday-FX-closed hide jump", async () => {
  ...
  assert.match(html.slice(shiftF10, shiftF10 + 180), /copyLastWeekdayFxOpenHourMarkdown\(\)/);
  assert.match(html.slice(shiftF11, shiftF11 + 180), /jumpToLastWeekdayFxOpenCopy\(\)/);
