...
test("1.5.35 keeps last-weekend-FX-open copy control without taking Shift+F10", async () => {
  ...
  assert.notEqual(app.match(/function copyLastWeekendFxOpenHourMarkdown/)?.[0], app.match(/function copyFirstWeekendFxOpenHourMarkdown/)?.[0]);
