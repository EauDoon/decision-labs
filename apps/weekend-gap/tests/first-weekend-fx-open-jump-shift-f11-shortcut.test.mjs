...
test("keyboard Shift+F11 is wired to the first-weekend-FX-open-hour copy control before unshifted F11", async () => {
  ...
  assert.notEqual(app.match(/function jumpToFirstWeekendFxOpenCopy/)?.[0], app.match(/function jumpToFirstWeekdayFxClosedCopy/)?.[0]);
  ...
  const shiftFn = app.slice(app.indexOf("function jumpToFirstWeekendFxOpenCopy"), app.indexOf("function jumpToHideWeekdayFxOpenFilter"));
