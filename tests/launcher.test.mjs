...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Wednesday late FX open, last-weekend-FX-closed copy, and weekend-FX-open hide in Weekend Gap 1.5.33' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Wednesday late FX open, last-weekend-FX-closed copy, and weekend-FX-open hide in Weekend Gap 1.5.33');
