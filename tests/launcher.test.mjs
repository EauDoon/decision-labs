...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Friday late FX open, last-closed-payout copy, and weekend-FX-closed hide in Weekend Gap 1.5.24' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Friday late FX open, last-closed-payout copy, and weekend-FX-closed hide in Weekend Gap 1.5.24');
