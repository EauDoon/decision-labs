...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Friday early bank open, last-open-payout copy, and weekend-payout-open hide in Weekend Gap 1.5.21' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Friday early bank open, last-open-payout copy, and weekend-payout-open hide in Weekend Gap 1.5.21');
