...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Sunday early payout, open-bank copy, and bank-open hide in Weekend Gap 1.5.15' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Sunday early payout, open-bank copy, and bank-open hide in Weekend Gap 1.5.15');
