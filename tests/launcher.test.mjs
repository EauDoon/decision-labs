...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Friday early payout, open-payout copy, and payout-open hide in Weekend Gap 1.5.13' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Friday early payout, open-payout copy, and payout-open hide in Weekend Gap 1.5.13');
