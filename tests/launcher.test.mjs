...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Saturday late payout, open-FX copy, and FX-open hide in Weekend Gap 1.5.14' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Saturday late payout, open-FX copy, and FX-open hide in Weekend Gap 1.5.14');
