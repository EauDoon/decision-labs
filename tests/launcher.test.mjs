...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Saturday early issuer open, last-closed-issuer copy, and weekend-issuer-closed hide in Weekend Gap 1.5.18' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Saturday early issuer open, last-closed-issuer copy, and weekend-issuer-closed hide in Weekend Gap 1.5.18');
