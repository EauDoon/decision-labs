...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Thursday early FX open, last-weekend-FX-open copy, and weekday-FX-open hide in Weekend Gap 1.5.34' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Thursday early FX open, last-weekend-FX-open copy, and weekday-FX-open hide in Weekend Gap 1.5.34');
