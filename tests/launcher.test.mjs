...
test('404 copy first What\'s new heading is distinct from Copy last What\'s new heading', async () => {
  ...
  const headings = [
    ...
    { textContent: 'Monday late FX open, first-weekday-FX-open copy, and weekday-FX-closed hide in Weekend Gap 1.5.29' },
  ];
  const document = {
    getElementById(id) {
  ...
  assert.equal(last, '- Monday late FX open, first-weekday-FX-open copy, and weekday-FX-closed hide in Weekend Gap 1.5.29');
