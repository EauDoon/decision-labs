...
test('catalog versions stay Partnership Breakpoint 1.5.24, Common Cart 1.4.24, The Smallest Agreement 1.5.24, Weekend Gap 1.5.23', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.24, Common Cart 1\.4\.24, The Smallest Agreement 1\.5\.24, Weekend Gap 1\.5\.23/);
