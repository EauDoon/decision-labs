...
test('catalog versions stay Partnership Breakpoint 1.5.48, Common Cart 1.4.48, The Smallest Agreement 1.5.47, Weekend Gap 1.5.47', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.48, Common Cart 1\.4\.48, The Smallest Agreement 1\.5\.47, Weekend Gap 1.5\.47/);
