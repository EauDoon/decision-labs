...
test('catalog versions stay Partnership Breakpoint 1.5.29, Common Cart 1.4.29, The Smallest Agreement 1.5.29, Weekend Gap 1.5.28', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.29, Common Cart 1\.4\.29, The Smallest Agreement 1\.5\.29, Weekend Gap 1\.5\.28/);
