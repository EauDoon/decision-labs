...
test('catalog versions stay Partnership Breakpoint 1.5.19, Common Cart 1.4.19, The Smallest Agreement 1.5.19, Weekend Gap 1.5.18', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.19, Common Cart 1\.4\.19, The Smallest Agreement 1\.5\.19, Weekend Gap 1\.5\.18/);
