...
test('catalog versions stay Partnership Breakpoint 1.5.47, Common Cart 1.4.47, The Smallest Agreement 1.5.46, Weekend Gap 1.5.46', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.47, Common Cart 1\.4\.47, The Smallest Agreement 1\.5\.46, Weekend Gap 1.5\.46/);
