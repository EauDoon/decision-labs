...
test('catalog versions stay Partnership Breakpoint 1.5.44, Common Cart 1.4.43, The Smallest Agreement 1.5.43, Weekend Gap 1.5.43', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.44, Common Cart 1\.4\.43, The Smallest Agreement 1\.5\.43, Weekend Gap 1.5\.43/);
