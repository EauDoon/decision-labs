...
test('catalog versions stay Partnership Breakpoint 1.5.35, Common Cart 1.4.35, The Smallest Agreement 1.5.35, Weekend Gap 1.5.34', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.35, Common Cart 1\.4\.35, The Smallest Agreement 1\.5\.35, Weekend Gap 1.5\.34/);
