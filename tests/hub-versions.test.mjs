...
test('catalog versions stay Partnership Breakpoint 1.5.37, Common Cart 1.4.37, The Smallest Agreement 1.5.36, Weekend Gap 1.5.36', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.37, Common Cart 1\.4\.37, The Smallest Agreement 1\.5\.36, Weekend Gap 1.5\.36/);
