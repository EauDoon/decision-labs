...
test('catalog versions stay Partnership Breakpoint 1.5.14, Common Cart 1.4.14, The Smallest Agreement 1.5.14, Weekend Gap 1.5.13', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.14, Common Cart 1\.4\.14, The Smallest Agreement 1\.5\.14, Weekend Gap 1\.5\.13/);
