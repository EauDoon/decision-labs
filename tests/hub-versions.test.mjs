...
test('catalog versions stay Partnership Breakpoint 1.5.40, Common Cart 1.4.40, The Smallest Agreement 1.5.39, Weekend Gap 1.5.39', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.40, Common Cart 1\.4\.40, The Smallest Agreement 1\.5\.39, Weekend Gap 1.5\.39/);
