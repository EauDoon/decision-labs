...
test('catalog versions stay Partnership Breakpoint 1.5.30, Common Cart 1.4.30, The Smallest Agreement 1.5.30, Weekend Gap 1.5.29', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.30, Common Cart 1\.4\.30, The Smallest Agreement 1\.5\.30, Weekend Gap 1.5\.29/);
