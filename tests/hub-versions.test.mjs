...
test('catalog versions stay Partnership Breakpoint 1.5.33, Common Cart 1.4.32, The Smallest Agreement 1.5.32, Weekend Gap 1.5.32', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.33, Common Cart 1\.4\.32, The Smallest Agreement 1\.5\.32, Weekend Gap 1.5\.32/);
