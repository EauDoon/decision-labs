...
test('catalog versions stay Partnership Breakpoint 1.5.27, Common Cart 1.4.26, The Smallest Agreement 1.5.26, Weekend Gap 1.5.26', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.27, Common Cart 1\.4\.26, The Smallest Agreement 1\.5\.26, Weekend Gap 1\.5\.26/);
