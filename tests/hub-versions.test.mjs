...
test('catalog versions stay Partnership Breakpoint 1.5.34, Common Cart 1.4.34, The Smallest Agreement 1.5.33, Weekend Gap 1.5.33', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.34, Common Cart 1\.4\.34, The Smallest Agreement 1\.5\.33, Weekend Gap 1.5\.33/);
