...
test('catalog versions stay Partnership Breakpoint 1.5.23, Common Cart 1.4.22, The Smallest Agreement 1.5.22, Weekend Gap 1.5.22', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.23, Common Cart 1\.4\.22, The Smallest Agreement 1\.5\.22, Weekend Gap 1\.5\.22/);
