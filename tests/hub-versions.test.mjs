...
test('catalog versions stay Partnership Breakpoint 1.5.36, Common Cart 1.4.36, The Smallest Agreement 1.5.36, Weekend Gap 1.5.36', () => {
  assert.match(html, /data-app="partnership-breakpoint">\s*1\.5\.36\s*</);
  ...
  assert.match(html, /data-app-version="partnership-breakpoint">\s*1\.5\.36\s*</);
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.36, Common Cart 1\.4\.36, The Smallest Agreement 1\.5\.36, Weekend Gap 1.5\.36/);
  assert.match(readme, /\[Partnership Breakpoint\]\(apps\/partnership-breakpoint\/\) \| 1\.5\.36 \|/);
