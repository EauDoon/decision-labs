...
test('catalog versions stay Partnership Breakpoint 1.5.45, Common Cart 1.4.45, The Smallest Agreement 1.5.44, Weekend Gap 1.5.44', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.45, Common Cart 1\.4\.45, The Smallest Agreement 1\.5\.44, Weekend Gap 1.5\.44/);
