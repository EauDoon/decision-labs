...
test('catalog versions stay Partnership Breakpoint 1.5.28, Common Cart 1.4.28, The Smallest Agreement 1.5.28, Weekend Gap 1.5.27', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.28, Common Cart 1\.4\.28, The Smallest Agreement 1\.5\.28, Weekend Gap 1\.5\.27/);
