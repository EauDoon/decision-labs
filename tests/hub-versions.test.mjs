...
test('catalog versions stay Partnership Breakpoint 1.5.36, Common Cart 1.4.36, The Smallest Agreement 1.5.35, Weekend Gap 1.5.35', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.36, Common Cart 1\.4\.36, The Smallest Agreement 1\.5\.35, Weekend Gap 1.5\.35/);
