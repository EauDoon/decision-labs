...
test('catalog versions stay Partnership Breakpoint 1.5.48, Common Cart 1.4.48, The Smallest Agreement 1.5.48, Weekend Gap 1.5.48', () => {
  assert.match(html, /data-app="partnership-breakpoint">\s*1\.5\.48\s*</);
  ...
  assert.match(html, /data-app-version="partnership-breakpoint">\s*1\.5\.48\s*</);
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.48, Common Cart 1\.4\.48, The Smallest Agreement 1\.5\.48, Weekend Gap 1.5\.48/);
  assert.match(readme, /\[Partnership Breakpoint\]\(apps\/partnership-breakpoint\/\) \| 1\.5\.48 \|/);
