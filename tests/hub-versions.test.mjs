...
test('catalog versions stay Partnership Breakpoint 1.5.17, Common Cart 1.4.17, The Smallest Agreement 1.5.17, Weekend Gap 1.5.16', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.17, Common Cart 1\.4\.17, The Smallest Agreement 1\.5\.17, Weekend Gap 1\.5\.16/);
