...
test('catalog versions stay Partnership Breakpoint 1.5.31, Common Cart 1.4.31, The Smallest Agreement 1.5.30, Weekend Gap 1.5.30', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.31, Common Cart 1\.4\.31, The Smallest Agreement 1\.5\.30, Weekend Gap 1.5\.30/);
