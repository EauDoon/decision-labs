...
test('catalog versions stay Partnership Breakpoint 1.5.38, Common Cart 1.4.38, The Smallest Agreement 1.5.37, Weekend Gap 1.5.37', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.38, Common Cart 1\.4\.38, The Smallest Agreement 1\.5\.37, Weekend Gap 1.5\.37/);
