...
test('catalog versions stay Partnership Breakpoint 1.5.32, Common Cart 1.4.32, The Smallest Agreement 1.5.31, Weekend Gap 1.5.31', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.32, Common Cart 1\.4\.32, The Smallest Agreement 1\.5\.31, Weekend Gap 1.5\.31/);
