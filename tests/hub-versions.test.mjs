...
test('catalog versions stay Partnership Breakpoint 1.5.42, Common Cart 1.4.41, The Smallest Agreement 1.5.41, Weekend Gap 1.5.41', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.42, Common Cart 1\.4\.41, The Smallest Agreement 1\.5\.41, Weekend Gap 1.5\.41/);
