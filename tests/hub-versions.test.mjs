...
test('catalog versions stay Partnership Breakpoint 1.5.10, Common Cart 1.4.10, The Smallest Agreement 1.5.10, Weekend Gap 1.5.11', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.10, Common Cart 1\.4\.10, The Smallest Agreement 1\.5\.10, Weekend Gap 1\.5\.11/);
