...
test('catalog versions stay Partnership Breakpoint 1.5.41, Common Cart 1.4.41, The Smallest Agreement 1.5.41, Weekend Gap 1.5.41', () => {
  assert.match(html, /data-app="partnership-breakpoint">\s*1\.5\.41\s*</);
  assert.match(html, /data-app="common-cart">\s*1\.4\.41\s*</);
  assert.match(html, /data-app="smallest-agreement">\s*1\.5\.41\s*</);
  ...
  assert.match(html, /data-app-version="smallest-agreement">\s*1\.5\.41\s*</);
  assert.match(html, /data-app-version="weekend-gap">\s*1\.5\.41\s*</);
  assert.match(html, /Partnership Breakpoint 1\.5\.41, Common Cart 1\.4\.41, The Smallest Agreement 1\.5\.41, Weekend Gap 1.5\.41/);
  ...
  assert.match(readme, /\[The Smallest Agreement\]\(apps\/smallest-agreement\/\) \| 1\.5\.41 \|/);
