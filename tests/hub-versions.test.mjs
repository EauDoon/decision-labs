...
test('catalog versions stay Partnership Breakpoint 1.5.22, Common Cart 1.4.21, The Smallest Agreement 1.5.21, Weekend Gap 1.5.21', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.22, Common Cart 1\.4\.21, The Smallest Agreement 1\.5\.21, Weekend Gap 1\.5\.21/);
