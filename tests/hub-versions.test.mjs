...
test('catalog versions stay Partnership Breakpoint 1.5.33, Common Cart 1.4.33, The Smallest Agreement 1.5.33, Weekend Gap 1.5.32', () => {
  ...
  assert.match(html, /data-app="weekend-gap">\s*1\.5\.32\s*</);
  ...
  assert.match(html, /data-app-version="weekend-gap">\s*1\.5\.32\s*</);
  assert.match(html, /Partnership Breakpoint 1\.5\.33, Common Cart 1\.4\.33, The Smallest Agreement 1\.5\.33, Weekend Gap 1.5\.32/);
  ...
  assert.match(readme, /\[Weekend Gap\]\(apps\/weekend-gap\/\) \| 1\.5\.32 \|/);
});
