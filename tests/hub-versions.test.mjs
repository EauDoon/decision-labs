...
test('catalog versions stay Partnership Breakpoint 1.5.25, Common Cart 1.4.25, The Smallest Agreement 1.5.24, Weekend Gap 1.5.24', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.25, Common Cart 1\.4\.25, The Smallest Agreement 1\.5\.24, Weekend Gap 1\.5\.24/);
