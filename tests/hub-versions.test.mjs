...
test('catalog versions stay Partnership Breakpoint 1.5.13, Common Cart 1.4.13, The Smallest Agreement 1.5.12, Weekend Gap 1.5.12', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.13, Common Cart 1\.4\.13, The Smallest Agreement 1\.5\.12, Weekend Gap 1\.5\.12/);
