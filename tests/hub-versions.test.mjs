...
test('catalog versions stay Partnership Breakpoint 1.5.49, Common Cart 1.4.49, The Smallest Agreement 1.5.49, Weekend Gap 1.5.48', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.49, Common Cart 1\.4\.49, The Smallest Agreement 1\.5\.49, Weekend Gap 1.5\.48/);
