...
test('catalog versions stay Partnership Breakpoint 1.5.26, Common Cart 1.4.25, The Smallest Agreement 1.5.25, Weekend Gap 1.5.25', () => {
  ...
  assert.match(html, /Partnership Breakpoint 1\.5\.26, Common Cart 1\.4\.25, The Smallest Agreement 1\.5\.25, Weekend Gap 1\.5\.25/);
