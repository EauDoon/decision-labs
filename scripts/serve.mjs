...
<head>
  ...
  <style>
    ...
    .copy-last-unlabelled-skip-target-text-tools, .copy-first-unlabelled-skip-target-id-tools, .copy-last-unlabelled-skip-target-id-tools, .copy-first-labelled-skip-target-id-tools, .copy-last-labelled-skip-target-id-tools, .copy-last-labelled-skip-labelledby-id-tools, .copy-first-labelled-skip-labelledby-id-tools, .copy-first-labelled-skip-labelledby-href-tools, .copy-last-labelled-skip-labelledby-href-tools, .copy-last-labelled-skip-labelledby-selector-tools, .copy-first-labelled-skip-labelledby-selector-tools, .copy-last-labelled-skip-labelledby-id-attr-tools, .copy-first-labelled-skip-labelledby-id-attr-tools { margin: 16px 0 0; }
    .copy-first-review-tools { margin: 16px 0 0; }
    .copy-last-review-tools { margin: 16px 0 0; }
    .copy-lede-tools { margin: 16px 0 0; }
    .copy-versions, .copy-trust, .copy-how, .copy-jobs, .copy-lede, .copy-version-line, .copy-first-trust, .copy-first-how, .copy-last-how, .copy-last-job, .copy-last-whats-new, .copy-first-whats-new, .copy-first-workbench, .copy-last-workbench, .copy-first-open, .copy-last-open, .copy-first-skip, .copy-last-skip, .copy-first-skip-text, .copy-last-skip-text, .copy-first-skip-target-text, .copy-last-skip-target-text, .copy-first-labelled-skip-target-text, .copy-last-labelled-skip-target-text, .copy-first-labelled-skip-href, .copy-last-labelled-skip-href, .copy-last-labelled-skip-text, .copy-first-labelled-skip-text, .copy-first-unlabelled-skip-text, .copy-last-unlabelled-skip-text, .copy-first-unlabelled-skip-href, .copy-last-unlabelled-skip-href, .copy-first-unlabelled-skip-target-text, .copy-last-unlabelled-skip-target-text, .copy-first-unlabelled-skip-target-id, .copy-last-unlabelled-skip-target-id, .copy-first-labelled-skip-target-id, .copy-last-labelled-skip-target-id, .copy-last-labelled-skip-labelledby-id, .copy-first-labelled-skip-labelledby-id, .copy-first-labelled-skip-labelledby-href, .copy-last-labelled-skip-labelledby-href, .copy-last-labelled-skip-labelledby-selector, .copy-first-labelled-skip-labelledby-selector, .copy-last-labelled-skip-labelledby-id-attr, .copy-first-labelled-skip-labelledby-id-attr, .copy-first-review, .copy-last-review {
      display: inline-flex;
      align-items: center;
      min-height: 44px;
      padding: 8px 14px;
